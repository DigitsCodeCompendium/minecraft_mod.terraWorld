...
public class ServerConfig extends BaseConfig
{
    ...
    public final Supplier<Month> wildCropMaturityStartMonth;
    public final Supplier<Month> wildCropMaturityEndMonth;
    // Blocks - Dispenser
    ...
    ServerConfig(ConfigBuilder builder)
    {
        ...
        wildCropMaturityEndMonth = builder.comment("The last month in which wild crops are mature, inclusive.").define("wildCropMaturityEndMonth", Month.OCTOBER);
