...
public enum AddHotspots implements RegionTask
{
    ...
    public void apply(RegionGenerator.Context context)
    {
        ...
        for (final var point : region.points())
        {
            ...
            {
                final Cellular2D.Cell cell = context.generator().plateRegionNoise.cell(
                    context.generator().topology.canonicalGridX(point.x),
                    context.generator().topology.canonicalGridZ(point.z));
