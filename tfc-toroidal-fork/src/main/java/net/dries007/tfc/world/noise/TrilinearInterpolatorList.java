...
public record TrilinearInterpolatorList(ChunkNoiseSamplingSettings settings, WorldTopology topology, List<TrilinearInterpolator> interpolators)
{
    public static TrilinearInterpolatorList create(ChunkNoiseSamplingSettings settings)
    {
        return create(settings, WorldTopology.PLANAR);
    }

    public static TrilinearInterpolatorList create(ChunkNoiseSamplingSettings settings, WorldTopology topology)
    {
        return new TrilinearInterpolatorList(settings, topology, new ArrayList<>());
    }

    public TrilinearInterpolator add(DensityFunction function)
    {
        final TrilinearInterpolator interpolator = new TrilinearInterpolator(settings, function, topology);
