...
public final class TrilinearInterpolator
{
    ...
    {
        this(settings, function, WorldTopology.PLANAR);
    }

    public TrilinearInterpolator(ChunkNoiseSamplingSettings settings, DensityFunction function, WorldTopology topology)
    {
        this.settings = settings;
        this.function = function;
        this.point = new MutableDensityFunctionContext(new BlockPos.MutableBlockPos(), topology);
