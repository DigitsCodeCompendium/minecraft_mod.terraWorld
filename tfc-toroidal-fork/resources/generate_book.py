...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('getting_started', 'Getting Started', 'An introduction to surviving in the world of TerraFirmaCraft. How to survive the stone age and obtain your first pickaxe.', 'tfc:stone/axe/sedimentary', is_sorted=True, entries=(
        entry('introduction', 'Introduction', 'tfc:rock/loose/granite', pages=(
            ...
            rock_knapping_typical('hoe_head', '$(thing)Hoes$() are useful tools for $(l:food/crops)Farming$(), but they can also be used to cut down leaves and other plant matter.').link(*link_rock_categories('tfc:stone/hoe_head/%s'), *link_rock_categories('tfc:stone/hoe/%s')),
            rock_knapping_typical('hammer_head', '$(thing)Hammers$() can be used as $(l:core_mechanics/damage_types)Crushing$() weapons, but are more important tools used for $(l:getting_started/primitive_anvils)Forging$().').link(*link_rock_categories('tfc:stone/hammer_head/%s'), *link_rock_categories('tfc:stone/hammer/%s')),
            rock_knapping_typical('javelin_head', 'Finally, a $(thing)Javelin$() can be used as a primitive weapon, capable of being thrown at targets, or used as a $(l:core_mechanics/damage_types)Piercing$() weapon.').link(*link_rock_categories('tfc:stone/javelin_head/%s'), *link_rock_categories('tfc:stone/javelin/%s')),
        )),
        entry('firepit', 'Pits of Fire', 'tfc:firepit', pages=(
            ...
            text('Using the firepit will now open the firepit screen. On the left are four $(thing)fuel$() slots. Logs, Peat, and Stick Bundles can all be used as firepit fuel by placing them in the topmost slot. Fuel will be consumed from the bottommost slot. There is a gauge which displays the current $(thing)Temperature$() of the firepit, and on the right, a slot for items to be $(l:core_mechanics/heating)heated$() in.'),
            ...
            heat_recipe('tfc:heating/food/cooked_cod', 'The fire pit is also a good device for $(thing)cooking food$(). All raw meats and doughs can be cooked in a firepit, which will lengthen their shelf life. (More on that $(l:food/decay)here$())'),
            text('The firepit can be extinguished at any time by using a $(thing)Shovel$() on it.$(br2)A firepit can also have other devices added to it to extend its functionality. Using a $(thing)Wrought Iron Grill$() will convert the firepit into a $(l:food/grill)Grill$(), and using a $(thing)Ceramic Pot$() will convert the firepit into a $(l:food/pot)Pot$(). To remove either device, $(item)$(k:key.use)$() while holding $(item)$(k:key.sneak)$(). Be careful not to try to remove a hot grill or pot!'),
            multimultiblock(
        ...
        entry('pottery', 'Pottery', 'tfc:ceramic/vessel', pages=(
            ...
            text('The small vessel is one such item. Like all pottery items, it must be $(l:https://en.wikipedia.org/wiki/Pottery)fired$() before it can be used. Firing is a process of $(l:core_mechanics/heating)heating$() the item up to a point where the clay will turn into a hard $(thing)Ceramic$() material, which requires heating to $(cfg:pitKilnTemperature), or $(bold)$(cfg:pitKilnHeat)$().$(br2)In order to do this in the early game, you will need to use a $(l:getting_started/pit_kiln)Pit Kiln$().', title='Small Vessel').link('tfc:ceramic/unfired_vessel').link('tfc:ceramic/vessel').anchor('vessel'),
            knapping('tfc:knapping/ceramic/unfired_vessel', 'Knapping a Clay Small Vessel.'),
            text('The $(l:food/decay#large_vessels)Large Vessel$() is created in a similar way. It can be placed, and has nine slots for items. View the linked chapter for more information.', title='Large Vessel'),
            knapping('tfc:knapping/ceramic/unfired_large_vessel', 'Knapping a Clay Large Vessel.'),
            text('Another useful pottery item is the $(thing)Jug$(). It can be used to pick up and $(thing)drink$() fluids, such as fresh water.$(br2)In order to use it, simply $(item)$(k:key.use)$() the jug on the fluid in the world. Then use the jug in order to drink from it. The jug can hold $(thing)$(cfg:jugCapacity)$() of fluid at a time.', title='Jug').link('tfc:ceramic/unfired_jug').link('tfc:ceramic/jug').anchor('jug'),
            ...
            knapping('tfc:knapping/ceramic/unfired_propick_head_mold', 'A $(l:metalworking/prospecting#propick)Prospector\'s Pick$() is an essential tool for locating large quantities of ore.').link('tfc:ceramic/unfired_propick_head_mold'),
            ...
            knapping('tfc:knapping/ceramic/unfired_saw_blade_mold', 'A $(thing)Saw$() is a tool which is required in order to craft advanced wooden components like a $(thing)Workbench$() along with many other devices like $(l:core_mechanics/support_beams)Supports$().').link('tfc:ceramic/unfired_saw_blade_mold', 'tfc:ceramic/saw_blade_mold'),
            ...
            knapping('tfc:knapping/ceramic/unfired_chisel_head_mold', 'A $(l:metalworking/chisel)Chisel$() is a tool used for smoothing blocks as well as creating a large number of decorative blocks.').link('tfc:ceramic/unfired_chisel_head_mold', 'tfc:ceramic/chisel_head_mold'),
            ...
            knapping('tfc:knapping/ceramic/unfired_hammer_head_mold', 'A $(thing)Hammer$() is an essential tool to create and work on $(l:metalworking/anvils)Anvils$().').link('tfc:ceramic/unfired_hammer_head_mold', 'tfc:ceramic/hammer_head_mold'),
            ...
            knapping('tfc:knapping/ceramic/unfired_hoe_head_mold', 'A $(thing)Hoe$() used for planting and maintaining $(l:food/crops)Crops$().').link('tfc:ceramic/unfired_hoe_head_mold', 'tfc:ceramic/hoe_head_mold'),
        ...
        entry('pit_kiln', 'Pit Kilns', 'tfc:textures/gui/book/icons/pit_kiln.png', pages=(
            text('A pit kiln is an early game method of $(l:core_mechanics/heating)heating$() items up. It can be used to $(thing)fire$() clay into ceramic, for example. The pit kiln, over the time period of about $(cfg:pitKilnTicks), will heat its contents up to $(cfg:pitKilnTemperature), or $(bold)$(cfg:pitKilnHeat)$().'),
        ...
        entry('panning', 'Panning', 'tfc:textures/gui/book/icons/panning.png', pages=(
            ...
            text('Panning can give three possible products: $(thing)Ore$(), $(thing)Loose Rocks$(), and $(l:mechanics/gems)Gems$(). The probabilities are as follows:$(br)$(li)Ore: 50%% $(li)Loose Rock: 25%% $(li)Gem: 1%% $(br) $()Each rock type has a specific gem that it will drop, that is exclusive to that rock type.', title='Products of Panning'),
            empty_last_page()
        )),
        entry('primitive_alloys', 'Primitive Alloys', 'tfc:ceramic/ingot_mold[tfc:fluid={id:"tfc:metal/bronze",amount:100}]', pages=(
            ...
            text('Other alloys are not suitable for creating tools. These are $(thing)Brass$(), $(thing)Rose Gold$(), and $(thing)Sterling Silver$().$(br2)$(thing)Brass$() is a useful alloy for all sorts of contraptions, including $(l:mechanics/mechanical_power)Mechanical Power$().$(br2)$(thing)Rose Gold$() and $(thing)Sterling Silver$() are used for crafting $(l:metalworking/steel#red_steel)Red Steel$() and $(l:metalworking/steel#blue_steel)Blue Steel$().', title='Utility Alloys'),
        ...
        entry('primitive_anvils', 'Primitive Anvils', 'tfc:rock/anvil/granite', pages=(
            text('An alternative to casting tools directly in the early game, and a requirement for higher tier metals, is to use an $(thing)Anvil$(). An anvil is a block which can be used for two different processes: $(l:metalworking/anvils#working)Working$() and $(l:metalworking/anvils#welding)Welding$(). This chapter is just going to show you how to obtain your first primitive stone anvil.').link(*['tfc:rock/anvil/%s' % r for r in ('granite', 'diorite', 'gabbro', 'rhyolite', 'basalt', 'andesite', 'dacite')]),
            ...
            text('You will also need any material of $(thing)Hammer$(). In order to make the anvil, simply right click the exposed $(thing)top$() face of one of those raw rock blocks with your $(thing)hammer$(), and voila! An anvil will be formed.$(br2)Anvils have $(l:metalworking/anvils#tiers)tiers$() and the rock anvil is Tier 0 - the lowest tier. It is only able to $(l:metalworking/anvils#welding)Weld$() Tier I ingots.', title='Rock Anvil').anchor('stone_anvils'),
            multimultiblock(
    ...
    book.category('core_mechanics', 'Core Mechanics', 'An introduction to the core gameplay mechanics and systems present in TerraFirmaCraft.', 'tfc:calendar_clock', is_sorted=True, entries=(
        entry('food_and_water', 'Food and Water', 'tfc:food/orange', pages=(
            ...
            text('There are five nutrients, all obtainable from food: $(l)$(a)Fruit$()$(), $(l)$(2)Vegetables$()$(), $(l)$(c)Protein$()$(), $(l)$(6)Grain$()$(), and $(l)$(5)Dairy$()$(). Having a large amounts of all nutrients increases your maximum health, while having a poor nutrition decreases it. Eating food gives you its nutrients. Meals such as $(l:food/pot#soup)Soup$() combine more nutrients into one meal. This is important, because meals you ate a while ago don\'t count towards your nutrition.', title='Nutrients').anchor('nutrients'),
            text('$(l)$(a)Fruit$()$(): Fruit nutrients are mostly found from $(l:the_world/wild_fruits)Fruiting Plants$(), like berry bushes, and fruit trees. A notable exception to this is $(l:food/crops#pumpkin)Pumpkins$() and $(l:food/crops#pumpkin)Melons$(), which nutritionally are fruits.$(br2)$(l)$(2)Vegetables$()$(): Found in nearly every $(l:food/crops)Crop$().$(br2)$(l)$(c)Protein$()$(): Protein can be gotten from the meat of $(l:the_world/wild_animals)Animals$(). It can also be obtained from $(l:food/crops#soybean)Soybeans$(), which have protein and vegetable nutrients.'),
            text('$(l)$(6)Grain$()$(): Grain is found in grain crops, such as $(l:food/crops#barley)Barley$(). The processing of grain is on the $(l:food/bread)Bread$() page. $(thing)Cattail$() and $(thing)Taro$() Roots are also grains.$(br2)$(l)$(5)Dairy$()$(): All dairy comes from $(thing)Milk$(), which comes from $(l:food/animal_husbandry#dairy_animals)Dairy Animals$(). Processing and drinking milk is covered on the $(l:food/dairy)Dairy$() page.$(br2)All the food in the world is not useful if it rots. See the $(l:food/decay)Preservation$() page for information on preventing that.'),
        ...
        entry('climate', 'Calendar and Climate', 'tfc:textures/gui/book/icons/thermometer.png', pages=(
            ...
            text('The annual rainfall is measured in millimeters (mm) and can be between 0mm - 500mm, though the instantaneous rainfall can reach 1000mm in highly seasonal climates. Rainfall affects the types of flora and fauna that are found in an area, as well as how often rain and snow occur.$(br)'),
        ...
        entry('heating', 'Heating', 'tfc:textures/gui/book/icons/heating.png', pages=(
            text('Heating items is a way of converting one item to another, or an item to a fluid. Items can be heated in many ways - in a $(l:getting_started/firepit)Firepit$(), a $(l:getting_started/pit_kiln)Pit Kiln$(), or a $(l:metalworking/charcoal_forge)Charcoal Forge$(), to name a few. However they all function in the same way. When you place items inside these devices, the items will gradually start to heat up. This is visible on the item\'s tooltip.'),
            text('The temperature of an item is represented by a color, which will change through the following values:$(br2)$(7)$(bold)Warming$(): $(cfg:heat:1) - $(cfg:heat:80)$(br)$(7)$(bold)Hot$(): $(cfg:heat:80) - $(cfg:heat:210)$(br)$(7)$(bold)Very Hot$(): $(cfg:heat:210) - $(cfg:heat:480)$(br)$(4)$(bold)Faint Red$(): $(cfg:heat:480) - $(cfg:heat:580)$(br)$(bold)$(4)Dark Red$(): $(cfg:heat:580) - $(cfg:heat:730)$(br)$(c)$(bold)Bright Red$(): $(cfg:heat:730) - $(cfg:heat:930)$(br)$(6)$(bold)Orange$(): $(cfg:heat:930) - $(cfg:heat:1100)$(br)$(#FFDD00)$(bold)$(t:Yellow)Yellow$(): $(cfg:heat:1100) - $(cfg:heat:1300)$(br)$(#FFDD00)$(t:Yellow White)$(bold)Yellow White$(): $(cfg:heat:1300) - $(cfg:heat:1400)$(br)$(d)$(bold)$(t:White)White$(): $(cfg:heat:1400) - $(cfg:heat:1500)$(br)$(d)$(bold)$(t:Brilliant White)Brilliant White$(): >$(cfg:heat:1500)'),
        )),
        entry('lighting', 'Light Sources', 'tfc:candle', pages=(
            ...
            text('$(br) 1. $(l:core_mechanics/lighting#torches)Torches$()$(br) 2. $(l:core_mechanics/lighting#candles)Candles$()$(br) 3. $(l:core_mechanics/lighting#jack_o_lanterns)Jack \'o Lanterns$()', 'Table of Contents'),
            ...
            text('Torches last for $(cfg:torchTicks), and then become $(thing)Dead Torches$(), which may be relit by clicking them with a torch, or by using a fire starting tool on them. Sticks can also be clicked on torches to light them. Torches dropped in water turn into $(thing)Wood Ash$() and $(thing)Sticks$().'),
            block_spotlight('Candles', text_content='Candles last for $(cfg:candleTicks), and may also be relit.', block='tfc:candle[candles=3,lit=true]').anchor('candles').link('tfc:candle', '#tfc:colored_candles'),
            sealed_barrel_recipe('tfc:barrel/candle', 'Candles can be made by sealing $(thing)String$() in a $(l:crafting/barrels)Barrel$() of $(l:mechanics/lamps#tallow)Tallow$().'),
            block_spotlight('Jack \'o Lanterns', 'Jack \'o Lanterns are the lit version of $(thing)Carved Pumpkins$(), and last for $(cfg:jackOLanternTicks), before reverting to carved pumpkins.', 'tfc:jack_o_lantern').anchor('jack_o_lanterns').link('tfc:jack_o_lantern'),
            text('$(thing)Carved Pumpkins$() are made by clicking $(item)$(k:key.use)$() with $(thing)Shears$() or a $(thing)Knife$() on a fresh $(l:food/crops#pumpkin)Pumpkin$(). Carved pumpkins do not rot, and can be worn on your head.'),
        )),
        entry('size_and_weight', 'Size and Weight', 'tfc:textures/gui/book/icons/size_and_weight.png', pages=(
            ...
            text('Size determines what storage blocks an item can fit inside of.$(br)$(li)$(thing)Tiny$() items fit in anything.$(li)$(thing)Very Small$() items fit in anything.$(li)$(thing)Small$() items are the largest item that will fit in $(l:food/decay#small_vessels)Small Vessels$()$().$(li)$(thing)Normal$() items are the largest that will fit in $(l:food/decay#small_vessels)Large Vessels$().', title='Size ⇲'),
            ...
            text('Items that count towards overburdening include $(thing)Anvils$(), $(thing)Sealed Barrels$(), $(thing)Crucibles$() (with contents)$(br2)Note: $(l:food/animal_husbandry#horses)Horses$() can also be overburdened.', title='Overburdening').anchor('overburdening'),
        )),
        entry('storage', 'Storage', 'tfc:wood/chest/oak', pages=(
            text('Your own inventory only holds so much, so there are many ways to keep items safe and organized, such as $(thing)Chests$() and $(thing)Crates$(), $(thing)Tool Racks$(), $(thing)Shelves$(), and $(thing)Baskets$().$(br2)Keep in mind that an item\'s $(l:core_mechanics/size_and_weight)Size ⇲$() limits which containers it will fit inside.'),
            ...
            text('For storing $(thing)food$() and slowing $(l:food/decay)decay$(), nothing use a $(thing)Vessel$(). See their chapters for details:$(br)$(li)$(l:food/decay#small_vessels)Small Vessels$()$(li)$(l:food/decay#large_vessels)Large Vessels$()', title='Vessels'),
        ...
        entry('support_beams', 'Support Beams & Collapses', 'tfc:wood/support/oak', pages=(
            ...
            text('Dirt, grass, clay, gravel, cobblestone, and sand are also affected by gravity. However, unlike vanilla gravity blocks, these blocks fall down slopes, and cannot be stacked more than one high without supporting blocks around. $(l:metalworking/sluices)Ore Deposits$() also landslide, but do not degrade in quality.'),
            ...
            text('Finally, it is important to know that $(l:metalworking/chisel)Chiseling$() has the potential to cause collapses, just as easily as mining does, when it is done on any $(thing)Raw Rock$() that has potential to cause a nearby collapse.$(br2)$(br2)Remember kids: practice safe mining!', title='Chiseling'),
        )),
    ))
    ...
    book.category('the_world', 'The World', 'All about the natural world around you.', 'tfc:grass/entisol', is_sorted=True, entries=(
        ...
        entry('ores_and_minerals', 'Ores and Minerals', 'tfc:ore/normal_hematite', pages=(
            ...
            # === Metal Ores Listing ===
            page_break(),
            text('Native Copper is an ore of $(thing)Copper$() metal. It can be found in $(l:the_world/geology#igneous_extrusive)Igneous Extrusive$() rocks, at elevations above y=40.$(br2)It can also be found in deposits in $(thing)rivers$(), which can be $(l:getting_started/panning)panned$().', title='Native Copper').link(*['tfc:ore/%s_%s' % (g, 'native_copper') for g in GRADES_ALL]).anchor('native_copper'),
            multimultiblock('Native Copper Ores in Dacite.', *[block_spotlight('', '', 'tfc:ore/%s_%s/%s' % (g, 'native_copper', 'dacite')) for g in GRADES]),
            text('Native Gold is an ore of $(thing)Gold$() metal. It can be found at elevations below y=70, but deeper veins are larger and richer. It can be found in $(l:the_world/geology#igneous_extrusive)Igneous Extrusive$() and $(l:the_world/geology#igneous_intrusive)Igneous Intrusive$() rocks.$(br2)It can also be found in deposits in $(thing)rivers$(), which can be $(l:getting_started/panning)panned$().', title='Native Gold').link(*['tfc:ore/%s_%s' % (g, 'native_gold') for g in GRADES_ALL]).anchor('native_gold'),
            multimultiblock('Native Gold Ores in Diorite.', *[block_spotlight('', '', 'tfc:ore/%s_%s/%s' % (g, 'native_gold', 'diorite')) for g in GRADES]),
            text('Native Silver is an ore of $(thing)Silver$() metal. Small poor veins can be found in $(thing)Granite$() or $(thing)Diorite$() in uplift regions, above y=90. Larger and richer veins can be found in $(thing)Granite$(), $(thing)Diorite$(), $(thing)Schist$(), and $(thing)Gneiss$() deep underground below y=20.$(br2)It can also be found in deposits in $(thing)rivers$(), which can be $(l:getting_started/panning)panned$().', title='Native Silver').link(*['tfc:ore/%s_%s' % (g, 'native_silver') for g in GRADES_ALL]).anchor('native_silver'),
            ...
            text('Cassiterite is an ore of $(thing)Tin$() metal. It can be found in $(l:the_world/geology#igneous_intrusive)Igneous Intrusive$() rocks at high elevation, above y=80 in uplift regions or in dikes.$(br2)It can also be found in deposits in $(thing)rivers$(), which can be $(l:getting_started/panning)panned$().', title='Cassiterite').link(*['tfc:ore/%s_%s' % (g, 'cassiterite') for g in GRADES_ALL]).anchor('cassiterite'),
            ...
            item_spotlight('tfc:kaolin_clay', 'Kaolinite', text_contents='Kaolinite is a soft $(thing)Mineral$() which is used in the construction of $(l:metalworking/fire_clay)Fire Clay$(). It can be found spawning at high altitudes in Plateaus, Old Mountains, Rolling Hills, and Highlands, at a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:18), with a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 300mm. The $(thing)Blood Lily$() flower grows on Kaolin clay.').link('tfc:red_kaolin_clay', 'tfc:pink_kaolin_clay', 'tfc:white_kaolin_clay', 'tfc:kaolin_clay_grass', 'tfc:kaolin_clay').anchor('kaolinite'),
            ...
            item_spotlight('tfc:ore/graphite', 'Graphite', text_contents='Graphite is a $(thing)Mineral$() which is used in the construction of $(l:metalworking/fire_clay)Fire Clay$(). It can be found in $(thing)Gneiss$(), $(thing)Marble$(), $(thing)Quartzite$(), and $(thing)Schist$() rocks, in elevations below y=60.').link('tfc:ore/%s' % 'graphite').anchor('graphite'),
            block_spotlight('', 'Graphite in Gneiss.', 'tfc:ore/%s/%s' % ('graphite', 'gneiss')),
            item_spotlight('tfc:ore/cinnabar', 'Cinnabar', text_contents='Cinnabar is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$() to obtain $(thing)Redstone Dust$(). It can be found in veins deep underground or high in mountains, in $(thing)Quartzite$(), $(thing)Granite$(), $(thing)Phyllite$(), $(thing)Schist$(), and $(thing)Gneiss$().').link('tfc:ore/%s' % 'cinnabar').anchor('cinnabar'),
            block_spotlight('', 'Cinnabar in Quartzite.', 'tfc:ore/%s/%s' % ('cinnabar', 'quartzite')),
            item_spotlight('tfc:ore/cryolite', 'Cryolite', text_contents='Cryolite is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$() to obtain $(thing)Redstone Dust$(). It can be found in veins deep underground, in $(thing)Granite$(), and $(thing)Diorite$().').link('tfc:ore/%s' % 'cryolite').anchor('cryolite'),
            block_spotlight('', 'Cryolite in Granite.', 'tfc:ore/%s/%s' % ('cryolite', 'granite')),
            item_spotlight('tfc:ore/saltpeter', 'Saltpeter', text_contents='Saltpeter is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$(), and then used in the crafting of $(thing)Gunpowder$(). It can be found in very large flat deposits near the surface in $(l:the_world/geology#sedimentary)Sedimentary$() rocks.').link('tfc:ore/%s' % 'saltpeter').anchor('saltpeter'),
            block_spotlight('', 'Saltpeter in Shale.', 'tfc:ore/%s/%s' % ('saltpeter', 'shale')),
            item_spotlight('tfc:ore/sulfur', 'Sulfur', text_contents='Sulfur is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$(), and then used in the crafting of $(thing)Gunpowder$(). It is found near lava level deep underground, in sparse but large and plentiful veins, in any $(l:the_world/geology#metamorphic)Metamorphic$() or $(l:the_world/geology#igneous_intrusive)Igneous Intrusive$() rock.').link('tfc:ore/%s' % 'sulfur').anchor('sulfur'),
            block_spotlight('', 'Sulfur in Gabbro.', 'tfc:ore/%s/%s' % ('sulfur', 'gabbro')),
            item_spotlight('tfc:ore/sylvite', 'Sylvite', text_contents='Sylvite is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$(), and then used as a $(l:food/fertilizers)Fertilizer$(). It can be found in very large flat deposits near the surface in $(thing)Shale$(), $(thing)Claystone$() and $(thing)Chert$().').link('tfc:ore/%s' % 'sylvite').anchor('sylvite'),
            block_spotlight('', 'Sylvite in Chert.', 'tfc:ore/%s/%s' % ('sylvite', 'chert')),
            item_spotlight('tfc:ore/borax', 'Borax', text_contents='Borax is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$() to produce $(l:metalworking/flux)Flux$(). It can be found in very large flat deposits near the surface in $(thing)Claystone$(), $(thing)Limestone$(), and $(thing)Shale$().').link('tfc:ore/%s' % 'borax').anchor('borax'),
            block_spotlight('', 'Borax in Shale.', 'tfc:ore/%s/%s' % ('borax', 'shale')),
            item_spotlight('tfc:ore/gypsum', 'Gypsum', text_contents='Gypsum is a decorative $(thing)Mineral$() which can be used to make $(l:mechanics/advanced_building_materials#plaster)Plaster$(). It can be found in very large flat deposits near the surface in $(l:the_world/geology#sedimentary)Sedimentary$() rocks.').link('tfc:ore/%s' % 'gypsum').anchor('gypsum'),
            block_spotlight('', 'Gypsum in Chalk.', 'tfc:ore/%s/%s' % ('gypsum', 'chalk')),
            item_spotlight('tfc:ore/halite', 'Halite', text_contents='Halite is a $(thing)Mineral$() which can be ground in the $(l:crafting/quern)Quern$() to make $(thing)Salt$(), which is an important $(l:food/decay#salting)Preservative$(). It can be found in very large flat deposits near the surface in $(l:the_world/geology#sedimentary)Sedimentary$() rocks.').link('tfc:ore/%s' % 'halite').anchor('halite'),
        ...
        entry('wild_crops', 'Wild Crops', 'tfc:textures/gui/book/icons/wild_crops.png', pages=(
            ...
            block_spotlight('Wild Wheat', 'An example of a wild crop, in this case $(l:food/crops#wheat)Wheat$().', 'tfc:wild_crop/wheat[mature=true]'),
            text('Every $(l:food/crops)crop$() that can be cultivated can also be found in the wild. Wild crops will look similar to their cultivated counterparts, but are more hidden within the grass. Wild crops are only mature from June to October. Otherwise, they appear dead until the next Summer.'),
            ...
            text('Wild crops will spawn in climates near where the crop itself can be cultivated, so if looking for a specific crop, look in the climate where the crop can be cultivated. However, unlike $(l:food/crops)Crops$() that the player has planted, wild crops do not require $(l:food/hydration)Hydration$(). Instead, they are found in areas depending on the average $()Temperature$() and $()Rainfall$().', title='Finding Wild Crops'),
        ...
        entry('wild_fruits', 'Wild Fruits', 'tfc:food/elderberry', pages=(
            ...
            text('The correct $(l:core_mechanics/climate#temperature)Temperature$() and $(l:food/hydration)Hydration$() are essential when planting fruit trees. Fruit trees will only grow and bear fruit if the Annual Average Temperature at the base of the tree (where the sapling is planted) is within that tree\'s range. Likewise, hydration is determined by the Average Annual Rainfall and water sources near to the base of the tree.'  ),
            empty(),
            page_break(),
            ...
            page_break(),
            fruit_tree_text('banana', 'Banana Tree', '$(br2)Bananas grow only vertically, lack leaves, and only fruit at the topmost block. Saplings are dropped from the flowering part of the plant. Once a banana plant is harvested, it dies, and must be replanted in the spring.'),
        ...
        entry('wild_animals', 'Wild Animals', 'tfc:medium_raw_hide', pages=(
            ...
            text('The world of TFC is full of animal life. Some animals are here to help, and some are incredibly dangerous. This section is about wild animals. For information on livestock, animals that can give you items you need, see the $(l:food/animal_husbandry)Animal Husbandry$() page.'),
            ...
            entity('tfc:polar_bear', 'The polar bear spawns in only the coldest regions, $(l:core_mechanics/climate#temperature)temperature$() at most $(cfg:temperature:10), with a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 100mm.', 'Polar Bear', 0.55),
            entity('tfc:grizzly_bear', 'The grizzly bear spawns in forests of moderate climates, with a $(l:core_mechanics/climate#temperature)temperature$() range of $(cfg:temperature:-15) to $(cfg:temperature:15) and at least 200mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Grizzly Bear', 0.55),
            entity('tfc:black_bear', 'The black bear spawns in forests of warmer, wetter climates, of $(l:core_mechanics/climate#temperature)temperature$() $(cfg:temperature:5) to $(cfg:temperature:20) and at least 250mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Black Bear', 0.55),
            entity('tfc:cougar', 'The cougar prefers most moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() from $(cfg:temperature:-10) to $(cfg:temperature:21) and at least 150mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Cougar', 0.6),
            entity('tfc:panther', 'The panther prefers most moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() from $(cfg:temperature:-10) to $(cfg:temperature:21) and at least 150mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Panther', 0.6),
            entity('tfc:lion', 'The lion spawns in plains with an average $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:16), and $(l:core_mechanics/climate#rainfall)rainfall$() between 50 and 300mm.', 'Lion', 0.55),
            entity('tfc:tiger', 'The tiger spawns in forests with an average $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:13), and $(l:core_mechanics/climate#rainfall)rainfall$() above 100mm.', 'Tiger', 0.55),
            entity('tfc:sabertooth', 'The sabertooth spawns at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:0), and any $(l:core_mechanics/climate#rainfall)rainfall$() above 250mm.', 'Sabertooth', 0.6),
            entity('tfc:wolf', 'The wolf spawns at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:22), and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 420mm. They hunt in packs. Feeding a wolf enough times will tame it into a $(l:food/pets)Dog$().'),
            entity('tfc:direwolf', 'The direwolf spawns at any $(l:core_mechanics/climate#temperature)temperature$() below freezing, and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 420mm. They hunt in packs. They are larger than regular wolves, and are not tamable.'),
            entity('tfc:hyena', 'The hyena spawns at any $(l:core_mechanics/climate#temperature)temperature$() warmer than $(cfg:temperature:15), and $(l:core_mechanics/climate#rainfall)rainfall$() between 80 and 380mm. They hunt in packs. They are not tamable.'),
            entity('tfc:crocodile', 'The crocodile spawns near rivers, lakes, and marshes at any $(l:core_mechanics/climate#temperature)temperature$() warmer than $(cfg:temperature:15), and at any $(l:core_mechanics/climate#rainfall)rainfall$(). They are nocturnal, and most dangerous in the water.', 'Crocodile', 0.7),
            entity('tfc:ocelot', 'The ocelot attacks small animals. It spawns at any $(l:core_mechanics/climate#temperature)temperature$() from $(cfg:temperature:15) to $(cfg:temperature:30), and $(l:core_mechanics/climate#rainfall)rainfall$() between 300 and 500mm, in forests. Feeding an ocelot enough times will tame it into a $(l:food/pets)Cat$(). Ocelots can eat raw fish'),
            page_break(),
            ...
            entity('tfc:boar', 'The boar spawns at $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:25) and above $(cfg:temperature:-5), and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.', 'Boar', 0.8),
            entity('tfc:moose', 'The moose spawns in forests at $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:10) and above $(cfg:temperature:-15), and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 300mm.'),
            entity('tfc:wildebeest', 'The wildebeest spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:13), and $(l:core_mechanics/climate#rainfall)rainfall$() between 90 and 380mm.'),
            entity('tfc:bison', 'The bison spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:-10) and below $(cfg:temperature:15), and $(l:core_mechanics/climate#rainfall)rainfall$() between 160 and 420mm.', 'Bison', 0.6),
            empty(),
            page_break(),
            ...
            entity('tfc:fox', 'The fox likes to eat the berries off of bushes. It can be found in forests with $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:25), and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.', 'Fox'),
            entity('tfc:deer', 'The deer spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:25) and above $(cfg:temperature:-15), and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.'),
            entity('tfc:caribou', 'The caribou spawns at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:-9), and $(l:core_mechanics/climate#rainfall)rainfall$() between 110 and 500mm.', 'Caribou', 0.5),
            entity('tfc:gazelle', 'The gazelle spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:12), and $(l:core_mechanics/climate#rainfall)rainfall$() between 90 and 380mm.'),
            entity('tfc:bongo', 'The bongo spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:15), and $(l:core_mechanics/climate#rainfall)rainfall$() between 230 and 500mm.', 'Bongo', 0.7),
            entity('tfc:grouse', 'The grouse spawns at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:13) and above $(cfg:temperature:-12), and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 400mm.'),
            entity('tfc:pheasant', 'The pheasant spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:17) and above $(cfg:temperature:-5), and $(l:core_mechanics/climate#rainfall)rainfall$() between 100 and 300mm.'),
            entity('tfc:turkey', 'The turkey spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below $(cfg:temperature:17) and above $(cfg:temperature:0), and $(l:core_mechanics/climate#rainfall)rainfall$() between 250 and 450mm.'),
            entity('tfc:peafowl', 'The peafowl spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:14), and $(l:core_mechanics/climate#rainfall)rainfall$() between 190 and 500mm.', 'Peafowl', 0.8),
            entity('tfc:armadillo', 'The armadillo sheds scutes every 30 hours. It can be found at any $(l:core_mechanics/climate#temperature)temperature$() above $(cfg:temperature:12), and $(l:core_mechanics/climate#rainfall)rainfall$() between 100 and 400mm.', 'Armadillo', 0.7),
            empty(),
            page_break(),
            ...
            entity('tfc:penguin', 'The penguin spawns on only the coldest beaches, ice sheet edges, and sea ice with $(l:core_mechanics/climate#temperature)temperature$() of at most $(cfg:temperature:-14) and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 75mm.', 'Penguin'),
            entity('tfc:leopard_seal', 'The Leopard Seal spawns on cold beaches, ice sheet edges, and sea ice with $(l:core_mechanics/climate#temperature)temperatures$() of at most $(cfg:temperature:-9) and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 105mm.', 'Leopard Seal'),
            entity('tfc:turtle', 'The sea turtle likes warm water. It spawns in $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:21) and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 250mm.', 'Sea Turtle'),
            empty(),
            page_break(),
            text('$(thing)Fish$() are small creatures that swim in water. Most of them can be $(l:food/fishing)fished$(). Some prefer oceans, rivers, or lakes.', title='Fish'),
            entity('tfc:cod', 'Cod prefer colder oceans, $(l:core_mechanics/climate#temperature)temperature$() at most $(cfg:temperature:18). They can be fished.', 'Cod'),
            entity('tfc:pufferfish', 'Pufferfish live in any ocean with at least a $(l:core_mechanics/climate#temperature)temperature$() of $(cfg:temperature:10).', 'Pufferfish'),
            entity('tfc:jellyfish', 'Jellyfish live in warmer oceans, with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:18).', 'Jellyfish'),
            entity('tfc:tropical_fish', 'Tropical fish prefer warmer oceans, with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:18).', 'Tropical Fish'),
            entity('tfc:salmon', 'Salmon spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-8) and at most $(cfg:temperature:12) and with rainfall of at least 250 mm.', 'Salmon'),
            entity('tfc:rainbow_trout', 'Rainbow Trout spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-12) and at most $(cfg:temperature:10) and with rainfall of at least 150 mm.', 'Rainbow Trout'),
            entity('tfc:lake_trout', 'Lake Trout spawn in any lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-5) and at most $(cfg:temperature:15) and with rainfall of at least 250 mm.', 'Lake Trout'),
            entity('tfc:largemouth_bass', 'Largemouth Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-14) and at most $(cfg:temperature:16) and with rainfall of at least 200 mm.', 'Largemouth Bass'),
            entity('tfc:smallmouth_bass', 'Smallmouth Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-14) and at most $(cfg:temperature:16) and with rainfall of less than 300 mm.', 'Smallmouth Bass'),
            entity('tfc:crappie', 'Crappie spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-10) and at most $(cfg:temperature:20).', 'Crappie'),
            entity('tfc:bluegill', 'Bluegill spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-10) and at most $(cfg:temperature:15).', 'Bluegill'),
            entity('tfc:northern_pike', 'Northern Pike spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-10) and at most $(cfg:temperature:26) with rainfall between 150 mm and 400 mm.', 'Northern Pike'),
            entity('tfc:peacock_bass', 'Peacock Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:12) and at most $(cfg:temperature:25) with rainfall between 200 mm and 400 mm.', 'Peacock Bass'),
            entity('tfc:arctic_char', 'Arctic Char spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-20) and at most $(cfg:temperature:-8) with rainfall between 150mm and 400 mm.', 'Arctic Char'),
            entity('tfc:muksun', 'Muksun spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-20) and at most $(cfg:temperature:-10) with rainfall of at least 250 mm.', 'Muksun'),
            entity('tfc:burbot', 'Burbot spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-16) and at most $(cfg:temperature:-9) with rainfall less than 350 mm.', 'Burbot'),
            entity('tfc:tilapia', 'Tilapia spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:10) and at most $(cfg:temperature:32) with rainfall less than 300 mm.', 'Tilapia'),
            entity('tfc:spotted_gudgeon', 'Spotted Gudgeon spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:6) and at most $(cfg:temperature:24) with rainfall less than 250 mm.', 'Spotted Gudgeon'),
            entity('tfc:pacu', 'Pacu spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:20) and at most $(cfg:temperature:35) with rainfall above 200 mm.', 'Pacu'),
            entity('tfc:red_piranha', 'Red Piranha spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:22) and at most $(cfg:temperature:35) with rainfall above 300 mm.', 'Red Piranha'),
            text('$(thing)Shellfish$() are small animals that live on the floor of bodies of water. They cannot be fished, but drop shells that can be eaten or made into $(l:metalworking/flux)flux$(). Shellfish can be $(l:food/fishing)bait$() for fish.', title='Shellfish').anchor('shellfish'),
            entity('tfc:isopod', 'Isopods spawn in deeper sections of oceans of $(l:core_mechanics/climate#temperature)temperature$() at most $(cfg:temperature:14).', 'Isopod'),
            entity('tfc:lobster', 'Lobster spawn in any ocean that is at most of a $(l:core_mechanics/climate#temperature)temperature$() of $(cfg:temperature:21).', 'Lobster'),
            entity('tfc:crayfish', 'Crayfish are like lobster, but spawn in rivers and lakes. They need a $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:5) and a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 125mm.', 'Crayfish'),
            entity('tfc:horseshoe_crab', 'Horseshoe crabs spawn in oceans of moderate climate, $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:10) and $(cfg:temperature:21) and with a $(l:core_mechanics/climate#rainfall)rainfall$() of at most 400mm.', 'Horseshoe Crab'),
            page_break(),
            ...
            entity('tfc:orca', 'Orca whales live in deep oceans with $(l:core_mechanics/climate#temperature)temperature$() of at most $(cfg:temperature:19) and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 100mm.', 'Orca', scale=0.25),
            entity('tfc:dolphin', 'Dolphins live in deep oceans with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:10) and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 200mm.', 'Dolphin', scale=0.4),
            entity('tfc:manatee', 'Manatees live in any warm lake, with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:20) and $(l:core_mechanics/climate#rainfall)rainfall$() of at most 300mm.', 'Manatee', scale=0.25),
    ...
    book.category('metalworking', 'Metalworking', 'Processing more advanced types of metals, from bronzes to steels.', 'tfc:metal/anvil/bronze', is_sorted=True, entries=(
        # Basic info for forging bronze
        entry('anvils', 'Anvils', 'tfc:metal/anvil/copper', pages=(
            text('Anvils are an important tool required for metalworking, as they allow you to work and weld metal ingots into various different forms.$(br2)Anvils can be useful for both $(l:metalworking/anvils#working)Working$(), which is used to form one piece of metal into another, or $(l:metalworking/anvils#welding)Welding$(), which is used to fuse two metal items into one solid piece.').link('#tfc:anvils'),
            block_spotlight('', 'All types of metal anvils.', '#tfc:anvils'),
            crafting('tfc:crafting/metal/anvil/copper', text_contents='Anvils can be crafted with $(thing)Double Ingots$() of their respective metal. For your first anvil, you must $(l:metalworking/anvils#welding)weld$() double ingots first on a $(l:getting_started/primitive_anvils)Stone Anvil$().'),
            ...
            item_spotlight('tfc:metal/pickaxe/wrought_iron[tfc:forging_bonus={type:"perfect"}]', 'Perfectly Forged', False, 'There are four tiers of forging bonus:$(li)Poorly Forged$(li)Well Forged$(li)Expertly Forged$(li)Perfectly Forged$(br2)These bonuses increase the power of your tool - making it break less often, mine faster, and/or do more damage in combat, depending on the tool.'),
            page_break(),
            ...
            text('You also need to have at least one $(l:metalworking/flux)Flux$() in the anvil to aid the welding process. Then, while both items are $(l:core_mechanics/heating)hot enough$() to weld - the tooltip will say "Can Weld" - you must use any $(thing)Hammer$() on the anvil. You will hear a hammering sound and the items will be welded together. They can then be extracted by using $(item)$(k:key.use)$() on the anvil with an empty hand.'),
        )),
        entry('flux', 'Flux', 'tfc:powder/flux', pages=(
            text('Flux is a powder which is required for $(l:metalworking/anvils#welding)Welding$() and also used as a catalyst in a $(l:metalworking/blast_furnace)Blast Furnace$(). Flux can be obtained by grinding specific items in a $(l:crafting/quern)Quern$().$(br2)Flux can be obtained in a number of ways, one of which is from its native ore, $(l:the_world/ores_and_minerals#borax)Borax$().').link('tfc:powder/flux'),
            quern_recipe('tfc:quern/powder/flux', 'Some rocks - $(thing)Limestone$(), $(thing)Dolomite$(), $(thing)Chalk$(), or $(thing)Marble$() - can also be used as flux, after being ground in a $(l:crafting/quern)Quern$(). Other items, including $(thing)Scutes$(), $(thing)Clams$(), $(thing)Mollusks$(), and the edible remains of $(l:the_world/wild_animals#shellfish)Shellfish$() can also be used to create flux.'),
        )),
        ...
        entry('charcoal_forge', 'Charcoal Forge', 'tfc:textures/block/molten_lit.png', pages=(
            text('The $(thing)Charcoal Forge$() is a device used to $(l:core_mechanics/heating)heat$() and melt items. Forges are necessary to make a $(l:metalworking/crucible)crucible$() work. They are typically used to heat items to prepare them for smithing on an $(l:metalworking/anvils)anvil$(). $(br)It is constructed with 5 $(thing)stone$() blocks surrounding a $(l:metalworking/charcoal_pit#charcoal_pile)charcoal pile$() of 7 or 8 layers which is then lit.'),
            multiblock('A Charcoal Forge', 'A complete forge multiblock, ready to be lit.', True, multiblock_id='tfc:charcoal_forge'),
            text('A Forge needs a chimney in order to work. The block directly above the Forge must be air, or a $(l:metalworking/crucible)Crucible$(). In addition, either the block directly above, or one of eight nearby blocks must be able to see the sky - the blue stained glass in the visualization to the right.$(br2)A $(l:metalworking/bellows)Bellows$() can be placed on one block up and adjacent to the Forge, in order to increase the maximum temperature it can reach.'),
            multiblock('', '', False, (
                ('  G  ', '  G  ', 'GGCGG', '  G  ', '  G  '),
        ...
        # Stuff unlocked by metal tools/useful at copper/bronze anvil stage
        entry('prospecting', 'Prospecting', 'tfc:metal/propick/wrought_iron', pages=(
            ...
            heat_recipe('tfc:heating/ceramic/propick_head_mold', 'Once the mold has been $(l:getting_started/pottery)knapped$(), it needs to be $(l:core_mechanics/heating)fired$() to create a $(thing)Propick Head Mold.$()$(br2)To create the tool head, $(l:getting_started/finding_ores#casting)cast$() liquid metal into the mold.'),
            anvil_recipe('tfc:anvil/metal/propick_head/wrought_iron', 'A Prospector\'s Pick Head can also be $(l:metalworking/anvils#working)smithed$() out of an $(thing)ingot$() of any tool metal on an $(l:metalworking/anvils)Anvil$().$(br2)The Prospector\'s Pick is then created by crafting the tool head with a stick.'),
        ...
        entry('chisel', 'Chisel', 'tfc:metal/chisel/wrought_iron', pages=(
            text('Chisels are a tool for creating decorative forms of other blocks, including slabs and stairs. In order to get started, you will need a $(thing)Chisel$() and any type of $(thing)Hammer$(). Chisels must be cast in molds or forged on an $(l:metalworking/anvils)Anvil$(). In order to start chiseling, hold the chisel in your main hand and a hammer in your off hand, and target a block in the world.').link('#c:tools/chisel'),
            ...
            text('Be careful! Chiseling in a mineshaft is not safe. Each time you chisel, there is a chance of $(l:core_mechanics/support_beams)Collapse$().')
        )),
        entry('sluices', 'Sluices', 'tfc:textures/gui/book/icons/sluice.png', pages=(
            text('The $(thing)Sluice$() is a device that is used to process $(thing)Ore Deposits$(), producing the same results that $(l:getting_started/panning)Panning$() does, with different probabilities.').link('#tfc:sluices'),
        ...
        entry('bloomery', 'Bloomery', 'tfc:bloomery', pages=(
            ...
            text('The bloomery can contain up to a maximum of $(cfg:bloomeryTotalCapacity) $(thing)Inputs$(), with $(cfg:bloomeryCapacity) items per layer of the chimney. To add layers to the chimney, stack up two more layers of stone blocks.$(br2)To add items to the bloomery, climb up to the top and throw items inside. A tower of grey ore should form.'),
            image('tfc:textures/gui/book/tutorial/bloomery_hole.png', text_contents='Adding items to the bloomery.'),
            text('The bloomery consumes $(thing)2 Charcoal$(), and $(thing)100 mB of Cast Iron$() to produce one $(thing)Bloom$(). After filling the bloomery with a combination of $(thing)Charcoal$() and $(thing)Ore$(), light the bloomery block, and wait 12 hours for the bloomery to smelt. When the bloomery shuts off, it leaves behind a $(thing)Bloom$() block. This contains $(thing)Raw Iron Blooms$() which can be obtained by mining the $(thing)Bloom$() repeatedly with a pickaxe.'),
            block_spotlight('The Bloom Block', 'A large $(thing)Bloom$().', 'tfc:bloom[layers=8]'),
            anvil_recipe('tfc:anvil/refined_iron_bloom', 'The $(thing)Raw Iron Bloom$() must be worked in a $(l:metalworking/anvils)anvil$() to make $(thing)Refined Iron Bloom$().').link('tfc:raw_iron_bloom'),
            anvil_recipe('tfc:anvil/metal/ingot/wrought_iron', 'The $(thing)Refined Iron Bloom$() must be worked in a $(l:metalworking/anvils)anvil$() to make $(thing)Wrought Iron Ingots$().').link('tfc:refined_iron_bloom'),
        ...
        entry('steel', 'Steel', 'tfc:metal/ingot/steel', pages=(
            text('Steel is an advanced material which can be used to create tools and $(l:mechanics/armor)Armor$(), and comes in a few different varieties: $(thing)Steel$(), $(thing)Black Steel$(), $(thing)Red Steel$(), and $(thing)Blue Steel$().$(br2)In order to create steel, you must first create $(thing)Pig Iron$() in a $(l:metalworking/blast_furnace)Blast Furnace$(), and cast it into $(thing)Ingots$().'),
            ...
            page_break(),
            text('$(thing)Black Steel$() is an advanced form of steel formed from an alloy of steel and some other metals. In order to create it, you will need to create an alloy called $(thing)Weak Steel$() in a $(l:metalworking/crucible)Crucible$().', title='Black Steel').anchor('black_steel'),
            alloy_recipe('Weak Steel', 'weak_steel', 'Molten $(thing)Weak Steel$() can be cast into ingots.').link('tfc:metal/ingot/weak_steel'),
            welding_recipe('tfc:welding/metal/ingot/high_carbon_black_steel', '$(thing)Weak Steel Ingots$() can then be welded with $(thing)Pig Iron Ingots$() to create $(thing)High Carbon Black Steel Ingots$(). Finally, these can be worked on an $(l:metalworking/anvils)Anvil$() to create $(thing)Black Steel Ingots$().').link('tfc:metal/ingot/high_carbon_black_steel', 'tfc:metal/ingot/black_steel'),
            text('$(thing)Black Steel$() can be used to craft tools and $(l:mechanics/armor)Armor$(), and also is used as a key ingredient in the creation of $(l:metalworking/steel#blue_steel)Blue Steel$() and $(l:metalworking/steel#red_steel)Red Steel$().'),
            page_break(),
            text('$(thing)Blue Steel$() is one of the two highest tier metals, along with $(l:metalworking/steel#red_steel)Red Steel$(). Similar to $(l:metalworking/steel#black_steel)Black Steel$(), the first step is to create an alloy of $(thing)Weak Blue Steel$() in a $(l:metalworking/crucible)Crucible$().', title='Blue Steel').anchor('blue_steel'),
            alloy_recipe('Weak Blue Steel', 'weak_blue_steel', '').link('tfc:metal/ingot/weak_blue_steel'),
            welding_recipe('tfc:welding/metal/ingot/high_carbon_blue_steel', '$(thing)Weak Blue Steel Ingots$() can be welded with $(l:metalworking/steel#black_steel)Black Steel Ingots$() to create $(thing)High Carbon Blue Steel Ingots$(). Finally, these can be worked on an $(l:metalworking/anvils)Anvil$() to create $(thing)Blue Steel Ingots$().').link('tfc:metal/ingot/high_carbon_blue_steel', 'tfc:metal/ingot/blue_steel'),
            text('$(thing)Blue Steel$() can be used to create tools and $(l:mechanics/armor)Armor$(), and a $(thing)Blue Steel Bucket$(), which can be used to transport $(cfg:metalBucketCapacity) of both liquid fluids, and $(6)Lava$().'),
            page_break(),
            text('$(thing)Red Steel$() is one of the two highest tier metals, along with $(l:metalworking/steel#blue_steel)Blue Steel$(). Similar to $(l:metalworking/steel#black_steel)Black Steel$(), the first step is to create an alloy of $(thing)Weak Red Steel$() in a $(l:metalworking/crucible)Crucible$().', title='Red Steel').anchor('red_steel'),
            alloy_recipe('Weak Red Steel', 'weak_red_steel', '').link('tfc:metal/ingot/weak_red_steel'),
            welding_recipe('tfc:welding/metal/ingot/high_carbon_red_steel', '$(thing)Weak Red Steel Ingots$() can be welded with $(l:metalworking/steel#black_steel)Black Steel Ingots$() to create $(thing)High Carbon Red Steel Ingots$(). Finally, these can be worked on an $(l:metalworking/anvils)Anvil$() to create $(thing)Red Steel Ingots$().').link('tfc:metal/ingot/high_carbon_red_steel', 'tfc:metal/ingot/red_steel'),
            text('$(thing)Red Steel$() can be used to create tools and $(l:mechanics/armor)Armor$(), and a $(thing)Red Steel Bucket$(), which can be used to transport $(cfg:metalBucketCapacity) of both liquid fluids, and $(6)Lava$()'),
        )),
        entry('crucible', 'Crucible', 'tfc:crucible', pages=(
            text('A $(thing)Crucible$() is an advanced device used for the creation of $(l:metalworking/crucible#advanced_alloying)Alloys$(). It is a more precise method than using a $(l:getting_started/primitive_alloys)Small Vessel$() to make alloys.$(br2)To obtain a crucible, you will first need to obtain some $(l:metalworking/fire_clay)Fire Clay$(), which is a stronger material than clay. This fire clay can then be knapped to shape it into an $()Unfired Crucible$().'),
            knapping('tfc:knapping/ceramic/unfired_crucible', 'Knapping an $(thing)Unfired Crucible$().').link('tfc:ceramic/unfired_crucible'),
            heat_recipe('tfc:heating/crucible', 'After the crucible is knapped, it will need to be $(thing)fired$(), like any piece of pottery - a $(l:getting_started/pit_kiln)Pit Kiln$() or $(l:metalworking/charcoal_forge)Charcoal Forge$() would do.$(br2)In order to use the crucible, it needs a source of heat. The crucible can be heated by any heatable block below, usually a $(l:metalworking/charcoal_forge)Charcoal Forge$()').link('tfc:crucible'),
            ...
            text('The temperature indicator on the left will rise based on external sources of heat, such as a $(l:metalworking/charcoal_forge)Charcoal Forge$() below or heat from a $(l:metalworking/blast_furnace)Blast Furnace$() from above. Metal can be extracted from the crucible as long as it is still molten.$(br2)Finally, the crucible will keep its contents when broken, allowing you to transport the alloy container around if you wish.'),
        )),
        entry('bellows', 'Bellows', 'tfc:bellows', pages=(
            text('A $(thing)Bellows$() is a device which can be used to increase the air flow through another device which lets them burn at a hotter temperature. However, by burning at a hotter temperature they will also consume fuel faster. The bellows can provide air to a device that is directly in front of it, or in front and one block down. This allows it to provide air to a $(l:getting_started/firepit)Firepit$(), or a $(l:metalworking/charcoal_forge)Charcoal Forge$() for example.'),
        ...
        entry('blast_furnace', 'Blast Furnace', 'tfc:blast_furnace', pages=(
            ...
            text('You will then need to construct the blast furnace, along with its $(thing)Chimney$(). The chimney must be composed out of $(l:metalworking/fire_clay#fire_bricks)Reinforced Fire Bricks$(), as they are strong enough to withstand the intense heat. These can be crafted from fire brick blocks, and either wrought iron or steel sheets.'),
        ...
        entry('fire_clay', 'Fire Clay', 'tfc:fire_clay', pages=(
            ...
            crafting('tfc:crafting/fire_clay', text_contents='Fire clay is made from $(l:the_world/ores_and_minerals#graphite)graphite$() powder, crushed in a $(l:crafting/quern)quern$(), as well as $(l:the_world/ores_and_minerals#kaolinite)kaolinite$() powder'),
            ...
            knapping('tfc:knapping/ceramic/unfired_crucible', 'The $(l:metalworking/crucible)Crucible$() in its unfired state is made from fire clay.').anchor('crucible'),
            knapping('tfc:knapping/ceramic/unfired_fire_brick', 'The $(l:metalworking/blast_furnace)Blast Furnace$() only accepts fire bricks as insulation.').anchor('fire_bricks'),
    ...
    book.category('food', 'Food and Agriculture', 'Everything to know about farming crops and raising animals.', 'tfc:food/maize_bread_jam_sandwich', is_sorted=True, entries=(
        # The big entries people use often
        entry('animal_husbandry', 'Animal Husbandry', 'minecraft:egg', pages=(
            ...
            text('$(thing)Mammals$() are livestock that experience $(thing)Pregnancy$(). Adult mammals that are above 30% familiarity and have been fed that day will mate, given that they are of opposite genders and near each other. The female animal will become $(thing)pregnant$(), which causes it to have children a set number of days after fertilization.$(br)An example is $(l:food/animal_husbandry#pig)Pigs$().').anchor('mammals'),
            text('$(thing)Wooly Animals$() are $(l:food/animal_husbandry#mammals)Mammals$() that can be $(thing)Sheared$() if they are adults and familiar enough to you. Some examples are $(l:food/animal_husbandry#sheep)Sheep$(), $(l:food/animal_husbandry#alpaca)Alpacas$(), and $(l:food/animal_husbandry#musk_ox)Musk Oxen$().').anchor('wooly_animals'),
            welding_recipe('tfc:welding/metal/shears/bronze', 'Shears can be made by $(l:metalworking/anvils#welding)welding$() two $(thing)knife blades$() together. Whichever knife blade has the lowest forging bonus will transfer that bonus (if any) to the shears.'),
            text('$(thing)Dairy Animals$() are mammals that make $(thing)Milk$(). Female dairy animals can be clicked with a bucket to obtain milk. Some examples are $(l:food/animal_husbandry#goat)Goats$(), $(l:food/animal_husbandry#cow)Cows$(), and $(l:food/animal_husbandry#yak)Yaks$().').anchor('dairy_animals'),
            crafting('tfc:crafting/nest_box', title='Nest Box', text_contents='$(thing)Oviparous Animals$() are not $(l:food/animal_husbandry#mammals)Mammals$(), and instead produce children by laying $(thing)Eggs$(). They need a $(thing)Nest Box$() to lay eggs, which they are capable of locating on their own.$(br)Some examples are $(l:food/animal_husbandry#duck)Ducks$(), $(l:food/animal_husbandry#quail)Quails$(), and $(l:food/animal_husbandry#chicken)Chickens$().').anchor('oviparous_animals'),
            ...
            text('$(thing)Equines$() are $(l:food/animal_husbandry#mammals)Mammals$() that can be ridden when tamed. They become rideable after reaching 15% familiarity. Horses pass on their $(thing)genetic traits$(), including their speed, jump height, health, size, and markings. The product of a horse and a donkey is a $(thing)mule$().'),
            knapping('tfc:knapping/saddle', 'Saddles may be knapped from leather.').anchor('horses'),
            text('They need a $(thing)Saddle$() to ride, which can be $(thing)Knapped$(). This includes $(l:food/animal_husbandry#mule)Mules$(), $(l:food/animal_husbandry#donkey)Donkeys$(), and $(l:food/animal_husbandry#horses)Horses$(). Mules and Donkeys can hold any chest or barrel. If holding a barrel, $(item)$(k:key.use)$() while holding $(item)$(k:key.sneak)$() can be used to remove it. The same keys while holding a bucket can be used to drain fluid from the barrel. $(br2)The next few pages will go over all livestock types.'),
            page_break(),
            text('$(thing)Pigs$() spawn in mild forests with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-10) and $(cfg:temperature:35), and at least 200mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#mammals)Mammals$() with no special abilities. They will eat any food, even if it is rotten. They have 1-10 children, are pregnant for just 19 days, and reach adulthood in 80 days. They can have children 6 times.', title='Pigs').anchor('pig'),
            entity('tfc:pig' + ANIMAL_NBT, 'A pig.', '', scale=0.6),
            text('$(thing)Rabbits$() spawn in $(l:core_mechanics/climate#temperature)temperatures$() above $(cfg:temperature:-16), and at least 15mm of $(l:core_mechanics/climate#rainfall)rainfall$(), changing their coat based on climate. They are $(l:food/animal_husbandry#mammals)Mammals$() with no special abilities, aside from being known for chewing on carrots and cabbage. They will eat any food, even if it is rotten. They have 1-6 children, are pregnant for just 19 days, and reach adulthood in 20 days. They can have children 6 times.', title='Rabbits').anchor('rabbit'),
            entity('tfc:rabbit' + ANIMAL_NBT, 'A rabbit.', '', scale=0.8),
            text('$(thing)Cows$() spawn in most climates, between $(l:core_mechanics/climate#temperature)temperature$() $(cfg:temperature:-10) and $(cfg:temperature:35), and at least 250mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#dairy_animals)Dairy Animals$(). They only eat $(thing)grains$(), which may be rotten. They can have 1-2 children, are pregnant for 58 days, and reach adulthood in 192 days. They can have children 13 times, if they are never milked, or be milked 128 times, if they are never bred. They produce milk every day.', title='Cows').anchor('cow'),
            entity('tfc:cow' + ANIMAL_NBT, 'A cow.', '', scale=0.75),
            text('$(thing)Goats$() spawn in moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-12) and $(cfg:temperature:25), and at least 300mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#dairy_animals)Dairy Animals$(). They eat $(thing)grains$(), $(thing)fruits$(), and $(thing)vegetables$(), which may be rotten. They can have 1-2 children, are pregnant for 32 days, and reach adulthood in 96 days. They can have children 6 times if they are never milked, or be milked 60 times if they are never bred. They produce milk every 3 days.', title='Goats').anchor('goat'),
            entity('tfc:goat' + ANIMAL_NBT, 'A goat.', '', scale=0.75),
            text('$(thing)Yaks$() spawn in cold climates, with $(l:core_mechanics/climate#temperature)temperature$() of at most $(cfg:temperature:-11), and at least 100mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#dairy_animals)Dairy Animals$(). They eat only fresh $(thing)grains$(). They always have 1 child, are pregnant for 64 days, and reach adulthood in 180 days. They can have children 23 times, if they are never milked, or be milked 230 times, if they are never bred. They produce milk once a day.', title='Yak').anchor('yak'),
            entity('tfc:yak' + ANIMAL_NBT, 'A yak.', '', scale=0.75),
            text('$(thing)Alpacas$() spawn in moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-8) and $(cfg:temperature:20), and at least 250mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#wooly_animals)Wooly Animals$(). They eat $(thing)grains$() and $(thing)fruits$(). They have 1-2 children, are pregnant for 36 days, and reach adulthood in 98 days. They can have children 13 times, if they are never sheared, or be sheared 128 times, if they are never bred. They grow wool every 4 days.', title='Alpaca').anchor('alpaca'),
            entity('tfc:alpaca' + ANIMAL_NBT, 'An alpaca.', '', scale=0.75),
            text('$(thing)Sheep$() spawn in drier climates, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:0) and $(cfg:temperature:35), and between 70 and 300mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#wooly_animals)Wooly Animals$(). They eat $(thing)grains$(). They have 1-2 children, are pregnant for 32 days, and reach adulthood in 56 days. They can have children 6 times, if they are never sheared, or be sheared 60 times, if they are never bred. They grow wool every 3 days.', title='Sheep').anchor('sheep'),
            entity('tfc:sheep' + ANIMAL_NBT, 'A sheep.', '', scale=0.75),
            text('$(thing)Musk Oxen$() spawn in cold climates, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-25) and $(cfg:temperature:0), and at least 100mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#wooly_animals)Wooly Animals$(). They eat $(thing)grains$(). They always have 1 child, are pregnant for 64 days, and reach adulthood in 168 days. They can have children 16 times, if they are never sheared, or be sheared 160 times if they are never bred. They grow wool every 3 days.', title='Musk Ox').anchor('musk_ox'),
            entity('tfc:musk_ox' + ANIMAL_NBT, 'A musk ox.', '', scale=0.75),
            text('$(thing)Bactrian Camels$() spawn in cold deserts, with $(l:core_mechanics/climate#temperature)temperature$() of at most $(cfg:temperature:-5), and at most 100mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#wooly_animals)Wooly Animals$() and can be ridden. They are slower than horses, but faster on sand and snow. They eat $(thing)grains$() and $(thing)fruits$(). They have 1 child, are pregnant for 24 days, and become adults in 80 days. They can have children 8 times if they are never sheared, or be sheared 80 times if they are never bred. They grow wool every 7 days.', title='Bactrian Camel').anchor('bactrian_camel'),
            entity('tfc:bactrian_camel' + ANIMAL_NBT, 'A bactrian camel.', '', scale=0.75),
            text('$(thing)Chickens$() spawn in warm forests, with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:14), and at least 225mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#oviparous_animals)Oviparous Animals$(). They eat $(thing)grains$(), $(thing)fruits$(), $(thing)vegetables$(), and $(thing)seeds$(), which can be rotten. Their eggs hatch in 8 days, and become adults in 24 days. They can lay eggs 100 times. They produce eggs every 30 hours.', title='Chickens').anchor('chicken'),
            entity('tfc:chicken' + ANIMAL_NBT, 'A chicken.', '', scale=0.7),
            text('$(thing)Ducks$() spawn in most plains, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-25) and $(cfg:temperature:30), and at least 100mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#oviparous_animals)Oviparous Animals$(). They eat $(thing)grains$(), $(thing)fruits$(), $(thing)vegetables$(), $(thing)bread$(), and $(thing)seeds$(). Their eggs hatch in 8 days, and become adults in 32 days. They can lay eggs 72 times. They produce eggs every 32 hours.', title='Ducks').anchor('duck'),
            entity('tfc:duck' + ANIMAL_NBT, 'A duck.', '', scale=0.7),
            text('$(thing)Quails$() spawn in colder climates, with $(l:core_mechanics/climate#temperature)temperature$() between $(cfg:temperature:-15) and $(cfg:temperature:15), and at least 200mm of  $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#oviparous_animals)Oviparous Animals$(). They eat $(thing)grains$(), $(thing)fruits$(), $(thing)vegetables$(), and $(thing)seeds$(), which can be rotten. Their eggs hatch in 8 days, and become adults in 22 days. They can lay eggs 48 times. They produce eggs every 28 hours.', title='Quail').anchor('quail'),
            entity('tfc:quail' + ANIMAL_NBT, 'A quail.', '', scale=0.7),
            text('$(thing)Donkeys$() spawn in wetter plains, with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-15), and between 130 and 400mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are a kind of $(l:food/animal_husbandry#horses)Equine$() that can carry a $(thing)chest$(). They eat $(thing)grains$() and $(thing)fruits$(). They have 1 child, are pregnant for 19 days, and reach adulthood in 80 days. They can have children 6 times.', title='Donkeys').anchor('donkey'),
            entity('tfc:donkey' + ANIMAL_NBT, 'A donkey.', '', scale=0.6),
            text('$(thing)Mules$() spawn in plains with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-15), and between 130 and 400mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are a kind of $(l:food/animal_husbandry#horses)Equine$() that can carry a $(thing)chest$() and are the sterile product of a $(thing)horse$() and a $()donkey$(). They eat $(thing)grains$() and $(thing)fruits$(). They reach adulthood in 80 days.', title='Mules').anchor('mule'),
            entity('tfc:mule' + ANIMAL_NBT, 'A mule.', '', scale=0.6),
            text('$(thing)Horses$() spawn in plains with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-15), and between 130 and 400mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are a kind of $(l:food/animal_husbandry#horses)Equine$(). They eat $(thing)grains$() and $(thing)fruits$(). They have 1 child, are pregnant for 19 days, and reach adulthood in 80 days. They can have children 6 times.', title='Horses').anchor('horse'),
            entity('tfc:horse' + ANIMAL_NBT, 'A horse.', '', scale=0.6),
            text('$(thing)Dromedary Camels$() spawn in drier climates, with $(l:core_mechanics/climate#temperature)temperature$() of at least $(cfg:temperature:-5), and at most 100mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They are $(l:food/animal_husbandry#mammals)Mammals$() that can be ridden. They are slower than horses, but are immune to cacti and run fast on sand. They eat $(thing)grains$() and $(thing)fruits$(). They have 1 child, are pregnant for 19 days, and reach adulthood in 80 days. They can have children 6 times.', title='Dromedary Camels').anchor('dromedary_camel'),
            entity('tfc:dromedary_camel' + ANIMAL_NBT, 'A dromedary camel.', '', scale=0.75),
            text('$(thing)Frogs$() spawn in $(l:core_mechanics/climate#temperature)temperatures$() above $(cfg:temperature:-13), and at least 150mm of $(l:core_mechanics/climate#rainfall)rainfall$(). They can be familiarized, and when bred they will lay eggs in fresh water, which hatch into tadpoles. They will eat fish and spider eyes. ', title='Frogs').anchor('frog'),
            entity('tfc:frog' + ANIMAL_NBT, 'A frog.', '', scale=0.8),
        )),
        entry('pets', 'Pets', 'minecraft:lead', pages=(
            text('$(thing)Pets$() are animals that function quite similar to $(l:food/animal_husbandry)Livestock$(), but have no useful products. Instead, they can obey commands, follow you around your home, control pests, and help you hunt.'),
        ...
        entry('crops', 'Crops', 'tfc:food/wheat', pages=(
            ...
            text('All crops need to be planted on $(l:food/farmland)farmland $()in order to grow. Some crops have additional requirements such as being waterlogged or requiring a stick to grow on.$(br2)Crops do not need $(thing)nutrients$() to grow, but they certainly help. There are three nutrients: $(3)Nitrogen$(), $(6)Phosphorous$(), and $(d)Potassium$(). Each crop may consume, or replenish, and combination of these three nutrients.', title='Growing Crops'),
            ...
            text(f'{detail_crop("pumpkin")}Pumpkins are a spreading crop. Pumpkin seeds can be planted on farmland and will place up to two $(thing)Pumpkin Blocks$() on the ground next to it while it is mature. If the pumpkin blocks are harvested, and the plant matures again, it can grow more pumpkins. Pumpkins can be made into $(l:core_mechanics/lighting#jack_o_lanterns)Jack \'o Lanterns$().', title='Pumpkins').link('tfc:seeds/pumpkin').anchor('pumpkin'),
            ...
            text(f'{detail_crop("papyrus")}Papyrus is a two block tall crop. Papyrus seeds can be planted on farmland, will grow two blocks tall, and will produce $(l:crafting/papermaking)Papyrus$() and $(thing)Papyrus Seeds$() as a product.', title='Papyrus').link('tfc:seeds/papyrus').link('tfc:papyrus').anchor('papyrus'),
            multimultiblock('', *[multiblock('', '', False, (('X',), ('Y',), ('Z',), ('0',)), {
        ...
        # Additional info related to farming
        entry('fertilizers', 'Fertilizers', 'tfc:powder/sylvite', pages=(
            text('Fertilizers are used to add nutrients to $(l:food/crops)crops$(). $(item)$(k:key.use)$() with a fertilizer in your hand on some $(thing)Farmland$() or a $(thing)Crop$() to add the nutrients. Particles should appear, indicating the fertilizer was added.$(br)The effectiveness of fertilizers are influenced by the type of $(l:food/farmland)Farmland$() they are used on.', title='Fertilization'),
            fertilizer('tfc:compost', 'Compost is the product of the $(l:food/composter)Composter$().', 0.2, 0, 0.2),
        ...
        entry('farmland', 'Soil Fertility', 'tfc:farmland/mollisol', pages=(
            text('There are eight varieties of soil occurring in different locations throughout the world. These soils range from very fertile, providing a 20% boost to all $(l:food/fertilizers)fertilizers$() applied to it, and to all nutrients recharged by $(l:food/crops)crops$(), to very poor, providing 20% less than typical soil.', title='Soil Fertility'),
            ...
            block_spotlight('Mollisol', text_content='Mollisol is found in cold grasslands with a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 250mm. It is a very high quality soil, receiving 20% bonus nutrients.', block='tfc:dirt/mollisol').link('tfc:dirt/mollisol').anchor('mollisol'),
        ...
        entry('composter', 'Composter', 'tfc:textures/gui/book/icons/composter.png', pages=(
            ...
            text('Composters operate better in certain conditions. Composters in regions of less than 150mm or greater than 350mm of rainfall operate much slower, with that effect getting stronger closer to the maximum and minimum rainfall. Also, composters that are touching other composters work slower.', title = 'Working Conditions'),
        ...
        entry('hydration', 'Keeping Hydrated', 'tfc:textures/gui/book/icons/hydrated.png', pages=(
            text('One challenge when farming is keeping your crops hydrated. Based on the $(l:core_mechanics/climate#rainfall)Rainfall$() in the area, the ground will have some latent moisture. However, this may not be enough especially for particularly water-intensive crops, or it may be too much to grow other crops.$(br2)In order to see the hydration of any specific block, you must have a $(thing)Hoe$() in hand.'),
        ...
        entry('aqueducts', 'Aqueducts', 'tfc:rock/aqueduct/shale', pages=(
            ...
            crafting('tfc:crafting/rock/aqueduct/shale', text_contents='Aqueduct blocks can be crafted with some $(l:mechanics/advanced_building_materials#bricks_and_mortar)Bricks and Mortar$().'),
        ...
        entry('decay', 'Preservation', 'minecraft:rotten_flesh', pages=(
            ...
            text('One of the easiest ways to preserve food is to use a $(thing)Vessel$(). $(thing)Large Vessels$() are a block which can store up to nine items, and when $(thing)sealed$() the items inside will gain the $(5)$(bold)Preserved$() status, which extends their remaining lifetime by $(cfg:traitPreservedModifier)x.$(br2)$(thing)Small Vessels$() are a item which can store up to four other items, and will also apply the $(5)$(bold)Preserved$() status to their contents.', title='Vessels').anchor('small_vessels'),
            block_spotlight('', 'A Sealed Large Vessel.', 'tfc:ceramic/large_vessel[sealed=true]').anchor('large_vessels'),
            text('One other way to easily preserve certain types of food is to cook them. $(thing)Meats$() will all expire slower when they are cooked than when they are raw.$(br2)It is also important to use the correct device for cooking. Certain devices that heat very hot, such as a $(l:metalworking/charcoal_forge)Charcoal Forge$() or a $(l:metalworking/crucible)Crucible$() are $(bold)bad$() for cooking food, which will make them expire faster!', title='Cooking'),
            heat_recipe('tfc:heating/food/cooked_mutton', 'Instead, a $(l:food/grill)Grill$() can even provide a buff for using it! Cooking mutton (pictured above) in a $(thing)Grill$() gives it the $(thing)Wood Grilled$() trait, multiplying its remaining lifetime by $(cfg:traitWoodGrilledModifier)x. Cooking in a $(l:metalworking/charcoal_forge)Charcoal Forge$() instead gives the $(thing)Charcoal Grilled$() trait, which multiplies its lifetime by $(cfg:traitCharcoalGrilledModifier)x.'),
            ...
            quern_recipe('tfc:quern/powder/salt', 'One way of getting salt is through $(l:crafting/quern)grinding$() $(l:the_world/ores_and_minerals#halite)Halite$(), which is a mineral.'),
            ...
            text('$(thing)Vinegar Preservation$() is a way of making fruits, veggies, and meat last longer.$(br2)$(thing)Vinegar$() is made in a $(l:crafting/barrels)Barrel$(), by sealing a fruit with 250mB of Alcohol. To preserve food in vinegar it must first be $(thing)Pickled$() in $(thing)Brine$(). Brine is made in a barrel with 1 part $(thing)Vinegar$() and 9 parts $(thing)Salt Water$().').anchor('vinegar'),
        ...
        entry('bread', 'Bread', 'tfc:food/barley_bread', pages=(
            text('Bread is the processed form of the various grain crops, such as $(l:food/crops#barley)Barley$(). Breaking a grain crop drops a raw, unprocessed grain item, which is not useful on its own. It must be processed into $(thing)Bread$(), which can then be eaten or used in $(l:food/sandwiches)Sandwiches$().').link('#c:foods/bread', '#c:foods/dough', '#c:foods/grain', '#c:foods/flour'),
            ...
            quern_recipe('tfc:quern/food/oat_flour', 'Grain must then be ground in a $(l:crafting/quern)Quern$() to make flour.'),
            ...
            heat_recipe('tfc:heating/food/barley_bread', 'Dough is then able to be $(l:core_mechanics/heating)heated$() to make bread. At this point it can also be used in $(l:food/sandwiches)Sandwiches$().'),
        )),
        entry('sandwiches', 'Sandwiches', 'tfc:food/barley_bread_sandwich', pages=(
            text('$(thing)Sandwiches$() are a meal allowing the combination of two $(l:food/bread)Bread$() items and up to three sandwich foods, which can be any combination of $(l:food/bread)Vegetables$(), $(thing)Cooked Meats$(), and $(l:food/dairy)Cheeses$().').link(*['tfc:food/%s_bread_sandwich' % g for g in GRAINS]),
            crafting('tfc:crafting/food/wheat_bread_sandwich_sss', text_contents='The sandwich recipe, which is executed in a $(thing)Workbench$().'),
        ...
        entry('pot', 'Firepit And Pot', 'tfc:pot', pages=(
            ...
            heat_recipe('tfc:heating/ceramic/pot', 'It then must be $(l:core_mechanics/heating)fired$() to create a $(thing)Ceramic Pot$() which can be used on the firepit.').link('tfc:ceramic/pot'),
        ...
        entry('salad', 'Salads', 'tfc:food/protein_salad', pages=(
            text('$(thing)Salads$() are a meal prepared in a $(thing)Bowl$() from up to five $(thing)Fruits$(), $(thing)Vegetables$(), or $(thing)Cooked Meats$().$(br2)Salads are one of the simplest meals to make, and just require a $(l:food/bowls)Bowl$(). First, hold the $(thing)Bowl$() and press $(item)$(k:key.use)$() while holding $(item)$(k:key.sneak)$(). This will open the salad screen.').link(*['tfc:food/%s_salad' % g for g in ('fruit', 'dairy', 'vegetables', 'protein', 'grain')]),
        ...
        entry('bowls', 'Bowls', 'tfc:ceramic/bowl', pages=(
            text('$(thing)Bowls$() are a versatile tool which can be used to make $(l:food/salad)Salads$(), to make $(l:food/pot)Soups$(), to $(l:food/decay#salting)Salt$() meat, or to apply $(thing)Powder$() to $(l:crafting/glassworking_applications#coloring)Glass$() in order to change the resulting glass\'s color.$(br2)Bowls can be made both from $(thing)Ceramic$(), by knapping a bowl out of clay, and then firing them.'),
            ...
            crafting('minecraft:bowl', text_contents='Bowls can also be made out of wood via crafting them together with $(thing)Glue$()$(br2)$(thing)Glue$() can be made by soaking $(thing)Bone Meal$() in a barrel of $(l:crafting/barrels#limewater)Limewater$().', title='Wooden Bowls').link('minecraft:bowl'),
            sealed_barrel_recipe('tfc:barrel/glue', 'Bowls can also be placed on the ground like blocks. When placed, they can be filled with any type of $(thing)Powder$() - the results of grinding ores, minerals, or gems in the $(l:crafting/quern)Quern$().'),
        ...
        entry('dairy', 'Dairy Products', 'tfc:food/cheese', pages=(
            text('$(thing)Dairy$() is a $(l:core_mechanics/food_and_water#nutrients)Nutrient$() obtained from the milk produced by $(l:food/animal_husbandry#dairy_animals)Dairy Animals$(). It can be drank, or processed into $(thing)Cheese$(). Drinking can be done out of a jug, and always restores $(l:core_mechanics/food_and_water#thirst)Thirst$(). However, it only adds to nutrition when drank after eating a food. Practically, this means that drinking milk twice in a row is ineffectual. A meal must precede it.', title='Dairy').link('minecraft:milk_bucket'),
            text('To start the $(thing)Cheesemaking$() process, add $(thing)Milk$() and $(thing)Vinegar$() in a $(l:crafting/barrels)Barrel$() at a ratio of 9:1. This is easiest done by filling 9 buckets of milk in a barrel, and adding a single bucket of vinegar. This produces $(thing)Milk Vinegar$().').link('tfc:food/cheese'),
            sealed_barrel_recipe('tfc:barrel/curdled_milk', 'Once milk and vinegar are mixed, it will curdle if it is sealed in a barrel for twelve hours. This requires no extra ingredients, except time.'),
            sealed_barrel_recipe('tfc:barrel/food/cheese', 'Cheese is then made by once again sealing the curdled milk in a barrel for 24 hours. Cheese is a long-lasting dairy product, and can be used in some meals to add dairy to them, such as $(l:food/sandwiches)Sandwiches$().')
        )),
        entry('jarring', 'Jarring', 'tfc:jar/plum', pages=(
            text('$(thing)Jars$() are used to preserve fruit for longer periods of time. Jars start as $(thing)Empty Jars$(), obtained through $(l:crafting/glassworking_applications#jar)Glassworking$(). Then, a $(thing)Jar Lid$() must be smithed from $(thing)Tin$(). Crafting these together creates an $(thing)Empty Jar With Lid$().'),
            text('In a pot, boil $(thing)Sugar$() with 2-4 pieces of $(thing)Fruit$(). When the recipe is done, $(item)$(k:key.use)$() with the empty jar with lid to create a $(thing)Sealed Jar of Jam$(). If you use a regular $(thing)Empty Jar$(), you can still retrieve the jam, but will be unable to $(thing)Can$() it.'),
            text('To complete the canning process, put the sealed jar of jam into the pot, and boil it with $(thing)Water$(). This gives it the $(thing)Canned$() trait, which will make it last for a long time, until it is unsealed.'),
        ...
        entry('fishing', 'Fishing', 'tfc:metal/fishing_rod/copper', pages=(
            ...
            anvil_recipe('tfc:anvil/metal/fish_hook/bismuth_bronze', 'First, you have to forge a fishing hook in an $(l:metalworking/anvils)Anvil$().'),
    ...
    book.category('crafting', 'Crafting Systems', 'An introduction to the various crafting systems added by TerraFirmaCraft.', 'tfc:wood/workbench/sequoia', is_sorted=True, entries=(
        # Crafting systems/devices
        entry('barrels', 'Barrels', 'tfc:wood/barrel/palm', pages=(
            ...
            crafting('tfc:crafting/wood/barrel/oak', text_contents='The barrel is made from seven $(thing)lumber$().'),
            ...
            instant_barrel_recipe('tfc:barrel/limewater', '$(bold)Limewater$() is made by adding $(l:metalworking/flux)Flux$() to a barrel of $(thing)Water$(). A single $(l:metalworking/flux)Flux$() is required for every $(thing) 500 mB$() of $(thing)Water$(). $(thing)Limewater$() is a reagent used in $(l:crafting/leather_making)Leather Making$(), and is used to make $(thing)Mortar$().').anchor('limewater'),
            ...
            text('Barrels have the ability to cool $(l:core_mechanics/heating)hot$() items. Put a hot item in a barrel of $(thing)Water$(), $(thing)Olive Oil$(), or $(thing)Salt Water$(), and it will quickly bring its temperature down.'),
            text('Barrels have the ability to $(l:mechanics/dye)Dye$() and $(l:mechanics/dye#lye)Bleach$() items. Most color-able things, like carpet, candles, and $(l:mechanics/advanced_building_materials#plaster)Plaster$() can be dyed by sealing them in a barrel of dye or bleached by sealing them in a barrel of lye. See the dye chapter for more information.'),
        ...
        entry('quern', 'Quern', 'tfc:quern', pages=(
            ...
            quern_recipe('tfc:quern/powder/flux', '$(l:metalworking/flux)Flux$() is also obtainable from the quern.'),
        )),
        entry('leather_making', 'Leatherworking', 'minecraft:leather', pages=(
            text('$(thing)Leather$() is a sturdy material formed from animal hides. It is required to craft $(l:mechanics/armor)Armor$(), $(thing)Saddles$(), or a $(l:metalworking/bellows)Bellows$(). $()Raw Hides$() must be treated through several processes: $(l:crafting/leather_making#soaking)soaking$(), $(l:crafting/leather_making#scraping)scraping$(), $(l:crafting/leather_making#preparing)preparing$(), and $(l:crafting/leather_making#tanning)tanning$() to turn them into $(thing)Leather$().'),
            ...
            text('Leather making will require several materials and tools. You will need:$(br)$(li)$(l:crafting/barrels#limewater)Limewater$() - a solution of $(l:metalworking/flux)Flux$() in $(thing)Water$()$(li)Water$(li)$(l:crafting/barrels#tannin)Tannin$() - an acidic solution made from the bark of some trees.$(li)$(thing)Raw Hides$()$(br2)With all that on hand, you are ready to begin the leather working process.'),
            sealed_barrel_recipe('tfc:barrel/medium_soaked_hide', 'First, raw hides must be $(thing)soaked$() to clean them and loosen unwanted material before processing. This can be done by sealing some $(thing)Raw Hide$() in a $(l:crafting/barrels#limewater)Barrel of Limewater$() for at least six hours.').anchor('soaking').link('tfc:small_soaked_hide', 'tfc:medium_soaked_hide', 'tfc:large_soaked_hide'),
            ...
            sealed_barrel_recipe('tfc:barrel/medium_prepared_hide', 'After scraping, $(thing)Scraped Hides$() must be sealed in a $(l:crafting/barrels)Barrel$() of $(thing)Water$() for at least six hours, for one final cleaning before tanning.').anchor('preparing').link('tfc:small_prepared_hide', 'tfc:medium_prepared_hide', 'tfc:large_prepared_hide'),
            sealed_barrel_recipe('tfc:barrel/medium_leather', 'Finally, $(thing)Prepared Hides$() must be sealed in a $(l:crafting/barrels#tannin)Barrel of Tannin$(), which is an acidic chemical compound that helps to convert the hide to $(thing)Leather$(). After another six hours, you can remove the $(thing)Leather$() from the barrel.').anchor('tanning').link('minecraft:leather'),
        )),
        entry('weaving', 'Weaving', 'tfc:spindle', pages=(
            text('$(thing)Weaving$() is the process of combining different kinds of string into $(thing)Cloth$(). While the last step of weaving is done in a $(thing)Loom$(), some cloths such as $(thing)Wool$(), obtained from $(l:food/animal_husbandry#wooly_animals)Wooly Animals$(), requires a $(thing)Spindle$() to obtain $(thing)Wool Yarn$() in order to be woven.'),
            knapping('tfc:knapping/ceramic/unfired_spindle_head', 'The $(thing)Unfired Spindle Head$() is knapped from clay. It can then be $(l:core_mechanics/heating)fired$() to make a $(thing)Spindle Head$(). To complete the spindle, craft it with a $(thing)Stick$().').link('tfc:spindle'),
            ...
            loom_recipe('tfc:loom/burlap_cloth', '$(thing)Burlap Cloth$() does not have a use, but it can be made from $(l:food/crops#jute)Jute Fiber$().').link('tfc:burlap_cloth').anchor('burlap_cloth'),
        ...
        entry('papermaking', 'Papermaking', 'tfc:unrefined_paper', pages=(
            text('$(thing)Paper$() is either made from the processed stalk of the $(l:food/crops#papyrus)Papyrus$() crop, or from $(l:crafting/papermaking#parchment)Animal Hides$(). Paper is useful for written materials like $(thing)Books$() and $(thing)Maps$().'),
            crafting('tfc:crafting/papyrus_strip', text_contents='Papyrus must first be cut into strips with a $(thing)Knife$()'),
            sealed_barrel_recipe('tfc:barrel/soaked_papyrus_strip', 'Then, papyrus strips are soaked in a $(l:crafting/barrels)Barrel$() of $(thing)Water$().'),
            loom_recipe('tfc:loom/unrefined_paper', 'Then, soaked papyrus strips are woven together in a loom to make $(thing)Unrefined Paper$(). Finally, it must be placed on a log and $(l:crafting/leather_making#scraping)Scraped$() to make $(thing)Paper$().'),
            ...
            page_break(),
            text('$(thing)Parchment Paper$() starts with a scraped hide. Review the $(l:crafting/leather_making)leather making chapter$() to learn how to make it. Parchment requires treatment with a few different items. First, $(thing)Pumice$() is needed. Pumice is found on the ground near $(l:the_world/geology)Volcanoes$(), or from $(l:metalworking/sluices)Sluicing$() or $(l:getting_started/panning)Panning$() ore deposits with Andesite, Rhyolite, or Dacite in them.', title='Parchment').anchor('parchment'),
            ...
            crafting('tfc:crafting/paper', text_contents='Treated hide, $(l:crafting/glassworking#lime)lime powder$(), flour, and a fresh egg will complete the treatment process and yield usable paper.'),
        )),
        entry('glassworking', 'Glassworking', 'tfc:silica_glass_bottle', pages=(
            ...
            crafting('tfc:crafting/silica_glass_batch', text_contents='Glass batches can then be crafted using one of the aforementioned colors of sand, plus $(l:crafting/glassworking#lime)Lime$() and a type of $(l:crafting/glassworking#potash)Potash$().'),
            heat_recipe('tfc:heating/powder/lime', '$(thing)Lime$() is one of the ingredients required to make glass batches. It is a powder obtained by $(l:core_mechanics/heating)heating$() $(l:metalworking/flux)Flux$().').anchor('lime').link('tfc:powder/lime'),
            ...
            page_break(),
            text('Glassworking is done by starting with a glass batch, and then completing a series of steps. These steps may require specific tools:$(br)$(li)A $(l:crafting/glassworking#blowpipe)Blowpipe$(), to $(thing)Blow$() and $(thing)Stretch$()$(li)A $(l:crafting/glassworking#paddle)Paddle$(), to $(thing)Flatten$()$(li)$(l:crafting/glassworking#jacks)Jacks$(), to $(thing)Pinch$()$(li)A $(l:crafting/glassworking#saw)Gem Saw$(), to $(thing)Saw$()', title='Tools of the Trade'),
            ...
            anvil_recipe('tfc:anvil/blowpipe', 'Ceramic blowpipes are brittle, and have a chance to to break when used. A more sturdy blowpipe can be $(l:metalworking/anvils#working)worked$() from a $(thing)Brass Rod$() on an anvil.'),
            ...
            text('$(bold)Flatten$()$(br)Use the $(thing)Blowpipe$() while holding a $(l:crafting/glassworking#paddle)Paddle$() in your offhand.$(br2)$(bold)Pinch$()$(br)Use the $(thing)Blowpipe$() while holding $(l:crafting/glassworking#jacks)Jacks$() in your offhand.$(br2)$(bold)Saw$()$(br)Use the $(thing)Blowpipe$() while holding a $(l:crafting/glassworking#saw)Gem Saw$() in your offhand.$(br2)$(bold)Roll$()$(br)Use the $(thing)Blowpipe$() with a $(l:crafting/weaving#wool_cloth)Wool Cloth$() in your offhand.'),
        )),
        entry('glassworking_applications', 'Glass Products', 'minecraft:glass', pages=(
            text('The most simple glass products are $(thing)Glass Panes$() and $(thing)Glass Blocks$(). In order to craft them, you must start with a $(l:crafting/glassworking#blowpipe)Blowpipe$() with a $(thing)Glass Batch$(), and then perform a $(thing)Pour$().$(br)$(li)$(bold)Table Pours$() are used to create $(thing)Glass Panes$()$(li)$(bold)Basin Pours$() are used to create $(thing)Glass Blocks$()'),
            ...
            page_break(),
            text('$(thing)Glass Panes$() are made with a $(thing)Table Pour$(). A pouring table is made by placing up to sixteen $(thing)Brass Plated Blocks$() in a continuous area.$(br2) 1. Add a $(l:crafting/glassworking)Glass Batch$() to a $(thing)Blowpipe$().$(br) 2. Heat the blowpipe to $(4)$(bold)Faint Red$().$(br) 3. $()$(item)$(k:key.use)$() the $(thing)Blowpipe$() on the top of the table.$(br) 4. Finally $(item)$(k:key.use)$() with a $(l:crafting/glassworking#paddle)Paddle$() to flatten the glass.', title='Table Pour').link('#c:glass_panes'),
            image(
                ...
                text_contents='Once the glass is cooled, it can be broken with a $(l:crafting/glassworking#saw)Gem Saw$() to obtain.'
            ),
            text('$(thing)Glass Blocks$() are made with a $(thing)Basin Pour$(). A basin is made by surrounding all sides of an air block except the top with $(thing)Brass Plated Blocks$().$(br2) 1. Add a $(l:crafting/glassworking)Glass Batch$() to a $(thing)Blowpipe$().$(br) 2. Heat the blowpipe to $(4)$(bold)Faint Red$().$(br) 3. $(item)$(k:key.use)$() the $(thing)Blowpipe$() on the top of the table.', title='Basin Pour').link('#c:glass_blocks'),
            image(
            ...
            page_break(),
            text('Glass has a natural color based on the type of $(l:crafting/glassworking)Glass Batch$() that was used. Other colors can be made using a $(l:food/bowls)Bowl$().$(br2)To use, place the $(l:food/bowls)Bowl$() on the ground, then $(item)$(k:key.use)$() the required $(thing)Powder$(). Before $(thing)Pouring$(), use the $(thing)Blowpipe$() on the bowl to add the powder to the batch.', title='Coloring Glass').anchor('coloring'),
            ...
            glassworking_recipe('tfc:glassworking/empty_jar', '$(l:food/jarring)Jars$() are also made from blown glass, but only silica or hematitic glass.').anchor('jar'),
        ...
        entry('sewing_table', 'Sewing Table', 'tfc:wood/sewing_table/oak', pages=(
            text('The $(thing)Sewing Table$() is used to produce banner patterns and smithing templates. It requires $(l:crafting/weaving#wool_cloth)Wool Cloth$(), $(l:crafting/weaving#burlap_cloth)Burlap Cloth$(), String or Yarn, as well as a Needle.'),
    ...
    book.category('mechanics', 'Miscellaneous', 'Advanced and miscellaneous sections of the tech tree.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/helmet/blue_steel', entries=(
        ...
        entry('wooden_buckets', 'Wooden Buckets', 'tfc:wooden_bucket', pages=(
            text('$(thing)Wooden Buckets$() are an early game fluid container. They can contain $(cfg:woodenBucketCapacity) of fluid. They can pick up any kind of fluid that is used for recipes, such as those in a $(l:food/pot)Pot$() or $(l:crafting/barrels)Barrel$(). However, wooden buckets cannot place source blocks. Dumping its fluid on the ground results in a small amount of fluid that quickly disappears.'),
        ...
        entry('dye', 'Dye', 'minecraft:red_dye', pages=(
            text('All 16 vanilla $(thing)Dye Colors$() can be obtained as items. Most flowers and other colorful plants can be ground into dye using a $(l:crafting/quern)Quern$(). Powders of $(l:the_world/ores_and_minerals)metal ores$() can be crafted directly into dye. $(l:the_world/ores_and_minerals#graphite)Graphite$(), $(l:the_world/ores_and_minerals#kaolinite)Kaolinite$(), $(l:the_world/ores_and_minerals#sylvite)Sylvite$(), $(l:the_world/ores_and_minerals#lapis_lazuli)Lapis$(), Coke, and Charcoal powder can be crafted into dye as well.'),
            item_spotlight('tfc:bucket/red_dye', 'Dye Liquids', text_contents='Dyes can also be made into fluids. A dye item and 1000mB of $(item)Water$() boiled in a $(l:food/pot)Pot$() produces the same amount of $(thing)Dye Fluid$(). Dye fluids are used in $(l:crafting/barrels)Barrels$() to color items.'),
            ...
            sealed_barrel_recipe('tfc:barrel/bleach_bed', 'Five $(item)Wood Ash$() and 1000mB of $(item)Water$() boiled in a $(l:food/pot)Pot$() produces lye. 25mB of Lye removes the color from a colored item.').anchor('lye'),
            text('$(li)$(item)Black Dye$() is used for $(l:crafting/scribing_table)Scribing Tables$().$(li)$(item)Red Dye$() is used for $(l:mechanics/powderkegs)Powderkegs$(). $(li)Unfired $(l:food/decay#small_vessels)Small Vessels$() and $(l:food/decay#large_vessels)Large Vessels$() can be dyed$().', title='Miscellaneous'),
            empty_last_page()
        )),
        entry('armor_trims', 'Armor Trims', 'minecraft:rib_armor_trim_smithing_template', pages=(
            text('Armor trims are produced with a $(thing)Trim Material$() and a $(l:crafting/sewing_table)Smithing Template$(). In TFC, all gems, along with Silver, Sterling Silver, Gold, Rose Gold, and Bismuth, can be used as trim materials. Armor trims are purely cosmetic.'),
        ...
        entry('advanced_building_materials', 'Advanced Materials', 'tfc:brick/rhyolite', pages=(
            ...
            text('$(br) 1. $(l:mechanics/advanced_building_materials#plaster)Plaster$()$(br) 2. $(l:mechanics/advanced_building_materials#bricks_and_mortar)Bricks and Mortar$()$(br)', title='Contents'),
            page_break(),
            # Plaster
            text('Plaster is a building block made from $(l:the_world/ores_and_minerals#gypsum)Gypsum$(). Plaster can be made by directly crafting with $(l:the_world/ores_and_minerals#gypsum)Gypsum$(), however it can be made more efficiently by sealing some $(l:the_world/ores_and_minerals#gypsum)Gypsum$() with 100 mB of $(thing)Limewater$() in a barrel.', title='Plaster').anchor('plaster').link('tfc:alabaster/raw', 'tfc:alabaster/polished'),
            crafting('tfc:crafting/alabaster_brick', 'tfc:crafting/alabaster/bricks', title='Plaster Bricks'),
            text('Plaster can be $(l:mechanics/dye)dyed$() in a $(l:crafting/barrels)Barrel$() of dye into any color. Raw Plaster blocks can also be $(l:metalworking/chisel)chiseled$() into $(thing)Polished Plaster$() using the $(thing)Smooth$() chisel mode, or crafted into stairs, slabs, or walls.', title='Plaster Decorations'),
            ...
            page_break(),
            text('$(thing)Stone Bricks$() can be made using a $(l:metalworking/chisel)Chisel$() with some individual loose rocks. It then requires $(thing)Mortar$() in order to form a strong building block.$(br2)Mortar can be made by adding $(thing)Sand$() to a barrel of $(l:crafting/barrels#limewater)Limewater$().', title='Bricks and Mortar').anchor('bricks_and_mortar'),
        ...
        entry('armor', 'Armor', 'tfc:metal/chestplate/copper', pages=(
            text('$(thing)Armor$() provides protection against attacks from predators and monsters. The quality of armor scales with the tier of the $(thing)Metal$(), with $(l:crafting/leather_making)Leather$() being the weakest and $(l:metalworking/steel)Colored Steels$() being the strongest.'),
            knapping('tfc:knapping/leather_chestplate', 'Leather armor is $(thing)Knapped$() from $(l:crafting/leather_making)Leather$(). It does not last long, but provides some decent protection if you have a full suit.').link(*['minecraft:leather_%s' % g for g in ('helmet', 'chestplate', 'leggings', 'boots')]),
            anvil_recipe('tfc:anvil/metal/unfinished_helmet/copper', '$(thing)Metal Armor$() requires multiple processing steps in an $(l:metalworking/anvils)Anvil$(). First, an $(thing)unfinished$() armor piece must be smithed. These require a $(thing)Double Sheet$() of the metal, except for boots which require a single sheet.'),
            welding_recipe('tfc:welding/metal/greaves/bismuth_bronze', 'Next, a $(thing)Sheet$() must be $(l:metalworking/anvils#welding)Welded$() to the armor piece to finish it. Chestplates require a $(thing)Double Sheet$() to be finished.'),
            text('Armor that is of the same tier but different metals may be subtly different. These are expressed in durability, as well as $(l:core_mechanics/damage_types)Damage Resistances$(). In order of increasing durability, the bronzes are ranked $(thing)Bismuth Bronze$(), regular $(thing)Bronze$(), and then $(thing)Black Bronze$(). For colored steels, $(thing)Red Steel$() lasts longer than $(thing)Blue Steel$().'),
        ...
        entry('powderkegs', 'Powderkegs', 'tfc:powderkeg', pages=(
            ...
            block_spotlight('The Powderkeg', 'Similar to the $(l:crafting/barrels)Barrel$(), the powderkeg is a device which can be sealed and unsealed with $(item)$(k:key.use)$(). Only sealed powderkegs may be ignited.', 'tfc:powderkeg[sealed=true]'),
        ...
        entry('channels', 'Casting with Channels', 'tfc:channel', pages=(
            ...
            text('$(li)Using a $(l:metalworking/bellows)Bellows$() on a $(thing)Mold Table$() will cool the metal faster.$()$(li)Activating a $(thing)Channel$() with a redstone pulse will start pouring the metal.$()$(li)$(thing)Mold Tables$() output a comparator signal.', 'Automation')
        )),
        ...
        entry('gems', 'Gems', 'tfc:gem/opal', pages=(
            ...
            item_spotlight('#tfc:gem_powders', text_contents='Gems can be ground into powder using a $(l:crafting/quern)Quern$(). Gem powders are particularly useful in $(l:crafting/glassworking_applications#coloring)Coloring Glass$().'),
            text('Through $(l:metalworking/sluices)Sluicing$() and $(l:getting_started/panning)Panning$(), $(thing)Uncut Gems$() can be obtained. The gem that can be obtained with the sluice is tied to the rock type of the deposit being processed.$(br2)To cut a gem, you must craft $(thing)Sandpaper$(). Sandpaper is made from Black Sand, Flux, Glue, any Gem Powder, and Paper. Crafting an uncut gem with sandpaper cuts the gem.'),
        ...
        entry('lamps', 'Lamps', 'tfc:metal/lamp/bismuth_bronze', pages=(
            ...
            crafting('tfc:crafting/metal/lamp/bronze', text_contents='Lamps are smithed in the $(l:metalworking/anvils)Anvil$() and crafted with $(l:crafting/glassworking_applications#lamp_glass)Lamp Glass$() to be completed.'),
            ...
            text('Boil the $(thing)Olive Paste$() with $(thing)Water$() in a $(l:food/pot)Pot$() to make $(thing)Olive Oil Water$(). Seal that in a $(l:crafting/barrels)Barrel$() with your $(thing)Jute Net$() to produce $(thing)Olive Oil$(). Olive oil burns for 6 in-game hours for every unit of fluid.'),
            text('Another lamp fuel is $(thing)Tallow$(). To make it, cook 5 $(thing)Blubber$(), in a $(l:food/pot)Pot$() of water. Tallow burns for 2 in-game hours per unit. It can be used to make $(l:core_mechanics/lighting#candles)Candles$()').anchor('tallow'),
            multimultiblock(
                'Lava will keep burning forever, but can only be held in a $(l:metalworking/steel#blue_steel)Blue Steel$() or $(l:metalworking/steel#red_steel)Red Steel$() lamp.',
                *[block_spotlight('', '', 'tfc:metal/lamp/%s[lit=true]' % metal) for metal in ('blue_steel', 'red_steel')],
                title='Lava Lamps'),
            anvil_recipe('tfc:anvil/metal/chain/black_steel', '$(thing)Chains$() are a great way to hang your lamps, and can be smithed in an $(l:metalworking/anvils)Anvil$().'),
            empty_last_page(),
        )),
        entry('minecarts', 'Minecarts', 'tfc:wood/chest_minecart/kapok', pages=(
            text('$(thing)Minecarts$() are a means of transporting players, entities, and large blocks. Blocks that would normally $(l:core_mechanics/size_and_weight#overburdening)overburden$() the player can be transported in minecarts. $(l:food/decay#large_vessels)Large Vessels$(), $(l:crafting/barrels)Barrels$(), $(l:mechanics/powderkegs)Powderkegs$(), $(l:metalworking/anvils)Anvils$(), and $(l:metalworking/crucible)Crucibles$() can be added to carts by pressing both $(item)$(k:key.use)$() and $(item)$(k:key.sneak)$(). Using $(item)$(k:key.sneak)$() with an empty hand removes the block. Forging minecart items can either be done with $(thing)Iron$() or $(thing)Steel$(), with the steel-based recipes being less expensive.').link('minecraft:minecart'),
        ...
        entry('mechanical_power', 'Mechanical Power', 'tfc:wood/water_wheel/oak', pages=(
            ...
            text('One device that can be connected to the mechanical network is a $(l:crafting/quern)Quern$(), simply by placing a vertical-facing axle above the Quern. While connected, the Quern cannot be turned manually, instead it will grind items automatically as the axle above rotates.$(br2)The Quern will grind faster if the axle above spins faster.', title='Quern Automation').anchor('quern'),
            multiblock('', 'A $(thing)Quern$() connected to an $(l:mechanics/mechanical_power#axle)Axle$().', multiblock_id='tfc:rotating_quern'),
            text('Another mechanical device is the $(thing)Trip Hammer$(). The Trip Hammer automatically performs smithing on an $(l:metalworking/anvils)Anvil$(). The Trip Hammer needs a $(thing)Bladed Axle$() to work. The Bladed Axle works like a regular axle, but has a blade on it that is used to activate the hammer.', title='Trip Hammer').anchor('trip_hammer'),
            ...
            text('$(l:crafting/weaving#power_loom)Weaving$() can be automated through the use of a $(l:crafting/weaving#power_loom)Power Loom$(). Read that chapter for more information.'),
            empty_last_page()
        )),
        entry('crankshaft', 'Crankshafts', 'tfc:crankshaft', pages=(
            text('A $(thing)Crankshaft$() is a way of turning $(l:mechanics/mechanical_power)Rotational Power$() into $(thing)Moving-back-and-forth Power$(). This can be useful in order to power devices such as the $(l:metalworking/bellows)Bellows$(), or $(l:mechanics/pumps)Water Pumps$().$(br2)The $(thing)Crankshaft$() consists of two parts: the base, and the shaft. The base must be connected to an $(l:mechanics/mechanical_power#axle)Axle$(), and devices can be connected to the end of the shaft.'),
...
def make_wild_crop_table(start_index: int, end_index: int) -> List[str | Dict[str, Any]]:
    crop_table = [
        ...
        for contents in ('Crop', 'Temperature', 'Rainfall (mm)')
    ]
    for idx, (crop, data) in enumerate(CROPS.items()):
        if start_index <= idx <= end_index:
            crop_table += [
                {'text': lang(crop)},
                '$(cfg:temperature:%s) - $(cfg:temperature:%s)' % (data.min_temp_wg, data.max_temp_wg),
...
def detail_crop(crop: str) -> str:
    ...
    # Temperature and hydration are pulled from the climate range data at render time, as datapacks may change them
    string= '$(bold)$(l:core_mechanics/climate#temperature)Temperature$(): $(cfg:climate.%s.temperature)$(br)$(bold)$(l:food/hydration)Hydration$(): $(cfg:climate.%s.hydration) %%$(br)$(bold)Category$(): %s$(br)$(br)' % (crop, crop, data.category.title())
    if nitrogen < 0:
...
def fruit_tree_text(fruit: str, title: str, text_contents: str) -> Page:
    data = FRUITS[fruit]
    return text(defer('Can be found in regions with: $(br)$(bold)$(l:core_mechanics/climate#temperature)Temperature$(): $(cfg:temperature:{0}) - $(cfg:temperature:{1})$(br)$(bold)$(l:core_mechanics/climate#rainfall)Rainfall$(): {2} - {3}mm$(br2)Conditions required for growth:$(br)$(bold)$(l:core_mechanics/climate#temperature)Temperature$(): $(cfg:climate.%s.temperature)$(br)$(bold)$(l:food/hydration)Hydration$(): $(cfg:climate.%s.hydration)%%' % (fruit, fruit) + text_contents, data.wild_min_temp, data.wild_max_temp, data.wild_min_water, data.wild_max_water), title=title).anchor(fruit).link('tfc:food/%s' % fruit, 'tfc:plant/%s_sapling' % fruit)
